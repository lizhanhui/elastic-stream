...
public final class SealRangeResponse extends Table {
  public static void ValidateVersion() { Constants.FLATBUFFERS_23_3_3(); }
  public static SealRangeResponse getRootAsSealRangeResponse(ByteBuffer _bb) { return getRootAsSealRangeResponse(_bb, new SealRangeResponse()); }
  public static SealRangeResponse getRootAsSealRangeResponse(ByteBuffer _bb, SealRangeResponse obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __reset(_i, _bb); }
  public SealRangeResponse __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static int createSealRangeResponse(FlatBufferBuilder builder,
      int statusOffset,
      int rangeOffset,
      int throttleTimeMs) {
    builder.startTable(3);
    SealRangeResponse.addThrottleTimeMs(builder, throttleTimeMs);
    SealRangeResponse.addRange(builder, rangeOffset);
    SealRangeResponse.addStatus(builder, statusOffset);
    return SealRangeResponse.endSealRangeResponse(builder);
  }

  public static void startSealRangeResponse(FlatBufferBuilder builder) { builder.startTable(3); }
  ...
  public static int endSealRangeResponse(FlatBufferBuilder builder) {
  ...
  public static final class Vector extends BaseVector {
    ...
    public SealRangeResponse get(int j) { return get(new SealRangeResponse(), j); }
    public SealRangeResponse get(SealRangeResponse obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
  public SealRangeResponseT unpack() {
    SealRangeResponseT _o = new SealRangeResponseT();
    unpackTo(_o);
    return _o;
  }
  public void unpackTo(SealRangeResponseT _o) {
  ...
  public static int pack(FlatBufferBuilder builder, SealRangeResponseT _o) {
    if (_o == null) return 0;
    ...
    return createSealRangeResponse(
      builder,
      _status,
      _range,

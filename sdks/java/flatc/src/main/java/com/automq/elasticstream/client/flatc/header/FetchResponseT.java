...
public class FetchResponseT {
  ...
  private com.automq.elasticstream.client.flatc.header.FetchResultEntryT[] entries;
  ...
  public com.automq.elasticstream.client.flatc.header.FetchResultEntryT[] getEntries() { return entries; }

  public void setEntries(com.automq.elasticstream.client.flatc.header.FetchResultEntryT[] entries) { this.entries = entries; }

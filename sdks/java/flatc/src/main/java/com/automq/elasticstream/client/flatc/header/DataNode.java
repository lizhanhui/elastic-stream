...
public final class DataNode extends Table {
  ...
  public static int endDataNode(FlatBufferBuilder builder) {
    ...
    builder.required(o, 6);  // advertise_addr
    return o;
  }
  ...
  public DataNodeT unpack() {
    DataNodeT _o = new DataNodeT();
    unpackTo(_o);
    return _o;
  }
  public void unpackTo(DataNodeT _o) {
    int _oNodeId = nodeId();
    _o.setNodeId(_oNodeId);
    String _oAdvertiseAddr = advertiseAddr();
    _o.setAdvertiseAddr(_oAdvertiseAddr);
  }
  public static int pack(FlatBufferBuilder builder, DataNodeT _o) {
    if (_o == null) return 0;

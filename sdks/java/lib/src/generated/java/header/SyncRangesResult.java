...
public final class SyncRangesResult extends Table {
  public static void ValidateVersion() { Constants.FLATBUFFERS_23_1_21(); }
  public static SyncRangesResult getRootAsSyncRangesResult(ByteBuffer _bb) { return getRootAsSyncRangesResult(_bb, new SyncRangesResult()); }
  public static SyncRangesResult getRootAsSyncRangesResult(ByteBuffer _bb, SyncRangesResult obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __reset(_i, _bb); }
  public SyncRangesResult __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static int createSyncRangesResult(FlatBufferBuilder builder,
      long streamId,
      short errorCode,
      int errorMessageOffset,
      int rangesOffset) {
    builder.startTable(4);
    SyncRangesResult.addStreamId(builder, streamId);
    SyncRangesResult.addRanges(builder, rangesOffset);
    SyncRangesResult.addErrorMessage(builder, errorMessageOffset);
    SyncRangesResult.addErrorCode(builder, errorCode);
    return SyncRangesResult.endSyncRangesResult(builder);
  }

  public static void startSyncRangesResult(FlatBufferBuilder builder) { builder.startTable(4); }
  ...
  public static int endSyncRangesResult(FlatBufferBuilder builder) {
  ...
  public static final class Vector extends BaseVector {
    ...
    public SyncRangesResult get(int j) { return get(new SyncRangesResult(), j); }
    public SyncRangesResult get(SyncRangesResult obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
  public SyncRangesResultT unpack() {
    SyncRangesResultT _o = new SyncRangesResultT();
    unpackTo(_o);
    return _o;
  }
  public void unpackTo(SyncRangesResultT _o) {
  ...
  public static int pack(FlatBufferBuilder builder, SyncRangesResultT _o) {
    if (_o == null) return 0;

...
public final class UpdateStreamsRequest extends Table {
  ...
  public UpdateStreamsRequestT unpack() {
    UpdateStreamsRequestT _o = new UpdateStreamsRequestT();
    unpackTo(_o);
    return _o;
  }
  public void unpackTo(UpdateStreamsRequestT _o) {
  ...
  public static int pack(FlatBufferBuilder builder, UpdateStreamsRequestT _o) {
    if (_o == null) return 0;
    int _streams = 0;
    ...
    return createUpdateStreamsRequest(
      builder,
      _o.getTimeoutMs(),
      _streams);
  }

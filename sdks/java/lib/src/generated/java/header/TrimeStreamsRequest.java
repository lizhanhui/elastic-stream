...
public final class TrimeStreamsRequest extends Table {
  public static void ValidateVersion() { Constants.FLATBUFFERS_23_1_21(); }
  public static TrimeStreamsRequest getRootAsTrimeStreamsRequest(ByteBuffer _bb) { return getRootAsTrimeStreamsRequest(_bb, new TrimeStreamsRequest()); }
  public static TrimeStreamsRequest getRootAsTrimeStreamsRequest(ByteBuffer _bb, TrimeStreamsRequest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __reset(_i, _bb); }
  public TrimeStreamsRequest __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static int createTrimeStreamsRequest(FlatBufferBuilder builder,
      int timeoutMs,
      int trimmedStreamsOffset) {
    builder.startTable(2);
    TrimeStreamsRequest.addTrimmedStreams(builder, trimmedStreamsOffset);
    TrimeStreamsRequest.addTimeoutMs(builder, timeoutMs);
    return TrimeStreamsRequest.endTrimeStreamsRequest(builder);
  }

  public static void startTrimeStreamsRequest(FlatBufferBuilder builder) { builder.startTable(2); }
  ...
  public static int endTrimeStreamsRequest(FlatBufferBuilder builder) {
  ...
  public static final class Vector extends BaseVector {
    ...
    public TrimeStreamsRequest get(int j) { return get(new TrimeStreamsRequest(), j); }
    public TrimeStreamsRequest get(TrimeStreamsRequest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}

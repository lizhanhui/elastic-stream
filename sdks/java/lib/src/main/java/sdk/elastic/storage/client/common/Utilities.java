...
public class Utilities {
    ...
    public static long crc32Calculation(byte[] array) {
    ...
    public static String crc32CheckSum(byte[] array) {
        return Long.toHexString(crc32Calculation(array)).toUpperCase(LOCALE);
    }

    /**
     * Calculate the CRC32 checksum of the given byte buffers.
     * If the given byte buffers is null or empty, return 0.
     *
     * @param buffers the byte buffers.
     * @return the CRC32 checksum.
     */
    public static long crc32Calculation(ByteBuffer[] buffers) {
    ...
    public static int calculateValidBytes(ByteBuffer[] buffers) {
        if (buffers == null || buffers.length == 0) {
            return 0;
        }
        int validBytes = 0;
        for (ByteBuffer buffer : buffers) {
            validBytes += buffer.remaining();
        }
        return validBytes;
    }

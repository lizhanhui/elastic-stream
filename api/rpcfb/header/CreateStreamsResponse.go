...
func (rcv *CreateStreamsResponse) ThrottleTimeMs() uint32 {
...
func (rcv *CreateStreamsResponse) MutateThrottleTimeMs(n uint32) bool {
...
func CreateStreamsResponseAddThrottleTimeMs(builder *flatbuffers.Builder, throttleTimeMs uint32) {

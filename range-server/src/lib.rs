...
mod mocks {
    ...
    use protocol::rpc::header::{
        ...
        ErrorCode, HeartbeatRequest, HeartbeatResponseT, IdAllocationRequest,
        IdAllocationResponseT, ListRangeRequest, ListRangeResponseT, PlacementDriverClusterT,
                                ...
                                match frame.operation_code {
                                    ...
                                    OperationCode::ListRange => {
                                        ...
                                        if let Some(buf) = frame.header.as_ref() {
                                            if let Ok(req) =
                                                flatbuffers::root::<ListRangeRequest>(buf)
                                            {
                                    ...
                                    OperationCode::CreateStream => {
                                        ...
                                        if let Some(buf) = frame.header.as_ref() {
                                                ...
                                                flatbuffers::root::<CreateStreamRequest>(buf)
                                            {
                                                ...
                                                error!(
                                                    "Failed to decode create-stream-request header"
                                                );
                                            }
                                        }
                                    }
                                    ...
                                    OperationCode::CreateRange => {
                                        ...
                                        if let Some(buf) = frame.header.as_ref() {
                                                ...
                                                flatbuffers::root::<CreateRangeRequest>(buf)
                                            {
                                                ...
                                                error!(
                                                    "Failed to decode create-range-request header"
                                                );
                                            }
                                        }
                                    }
                                    ...
                                    OperationCode::SealRange => {
                                        ...
                                        if let Some(buf) = frame.header.as_ref() {
                                            if let Ok(req) =
                                                flatbuffers::root::<SealRangeRequest>(buf)
                                            {
                                                serve_seal_range(&req, &mut response_frame);
                                            } else {
                                                error!(
                                                    "Failed to decode seal-ranges-request header"
                                                );
                                            }
                                        }
                                    }

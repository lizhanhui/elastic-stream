...
pub mod header {
    ...
    impl ErrorCode {
        ...
        pub const ENUM_VALUES: &'static [Self] =
            &[Self::NONE, Self::UNKNOWN, Self::INVALID_REQUEST];
    ...
    impl<'a> SystemErrorResponse<'a> {
        ...
        pub fn error_code(&self) -> ErrorCode {
            ...
            unsafe {
                self._tab
                    .get::<ErrorCode>(SystemErrorResponse::VT_ERROR_CODE, Some(ErrorCode::NONE))
                    .unwrap()
            }
        }
        #[inline]
        pub fn error_message(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(
                    SystemErrorResponse::VT_ERROR_MESSAGE,
                    None,
                )
            }
        }
    ...
    impl<'a: 'b, 'b> SystemErrorResponseBuilder<'a, 'b> {
        ...
        pub fn add_error_code(&mut self, error_code: ErrorCode) {
            self.fbb_.push_slot::<ErrorCode>(
                SystemErrorResponse::VT_ERROR_CODE,
                error_code,
                ErrorCode::NONE,
            );
        }
        ...
        ) -> SystemErrorResponseBuilder<'a, 'b> {
            ...
            unsafe {
                self._tab
                    .get::<ClientRole>(
                        ...
                        Some(ClientRole::CLIENT_ROLE_UNKNOWN),
                    )
                    .unwrap()
            }
        }
    ...
    impl<'a> HeartbeatResponse<'a> {
        ...
        pub fn error_code(&self) -> ErrorCode {
            ...
            unsafe {
                self._tab
                    .get::<ErrorCode>(HeartbeatResponse::VT_ERROR_CODE, Some(ErrorCode::NONE))
                    .unwrap()
            }
        }
        #[inline]
        pub fn error_message(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(
                    HeartbeatResponse::VT_ERROR_MESSAGE,
                    None,
                )
            }
        }
    ...
    impl<'a: 'b, 'b> HeartbeatResponseBuilder<'a, 'b> {
        ...
        pub fn add_error_code(&mut self, error_code: ErrorCode) {
            self.fbb_.push_slot::<ErrorCode>(
                HeartbeatResponse::VT_ERROR_CODE,
                error_code,
                ErrorCode::NONE,
            );
        }
    ...
    impl<'a> AppendRequest<'a> {
        ...
        pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
            ...
            if let Some(x) = args.append_requests {
                builder.add_append_requests(x);
            }
        ...
        pub fn append_requests(
            &self,
        ) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<AppendInfo<'a>>>> {
            // Safety:
            // Created from valid Table for this object
            // which contains a valid value in this slot
            unsafe {
                self._tab.get::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<AppendInfo>>,
                >>(AppendRequest::VT_APPEND_REQUESTS, None)
            }
        }
    }
        ...
        fn run_verifier(
            ...
            v.visit_table(pos)?
                ...
                .visit_field::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<AppendInfo>>,
                >>("append_requests", Self::VT_APPEND_REQUESTS, false)?
                .finish();
            Ok(())
        }
    }
    pub struct AppendRequestArgs<'a> {
        pub timeout_ms: i32,
        pub append_requests: Option<
            flatbuffers::WIPOffset<
                flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<AppendInfo<'a>>>,
            >,
        >,
    }
    ...
    impl<'a: 'b, 'b> AppendRequestBuilder<'a, 'b> {
        ...
        #[inline]
        pub fn add_append_requests(
            &mut self,
            append_requests: flatbuffers::WIPOffset<
                flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<AppendInfo<'b>>>,
            >,
        ) {
            self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
                AppendRequest::VT_APPEND_REQUESTS,
                append_requests,
            );
        }
        #[inline]
    ...
    impl<'a> AppendInfo<'a> {
        ...
        pub fn stream_id(&self) -> i64 {
            ...
            unsafe {
                self._tab
                    .get::<i64>(AppendInfo::VT_STREAM_ID, Some(0))
                    .unwrap()
            }
        }
        #[inline]
        pub fn request_index(&self) -> i32 {
            ...
            unsafe {
                self._tab
                    .get::<i32>(AppendInfo::VT_REQUEST_INDEX, Some(0))
                    .unwrap()
            }
        }
        #[inline]
        pub fn batch_length(&self) -> i32 {
            ...
            unsafe {
                self._tab
                    .get::<i32>(AppendInfo::VT_BATCH_LENGTH, Some(0))
                    .unwrap()
            }
        }
    }
    ...
    impl<'a: 'b, 'b> AppendInfoBuilder<'a, 'b> {
        ...
        pub fn add_stream_id(&mut self, stream_id: i64) {
            self.fbb_
                .push_slot::<i64>(AppendInfo::VT_STREAM_ID, stream_id, 0);
        }
        #[inline]
        pub fn add_request_index(&mut self, request_index: i32) {
            self.fbb_
                .push_slot::<i32>(AppendInfo::VT_REQUEST_INDEX, request_index, 0);
        }
        #[inline]
        pub fn add_batch_length(&mut self, batch_length: i32) {
            self.fbb_
                .push_slot::<i32>(AppendInfo::VT_BATCH_LENGTH, batch_length, 0);
        }
        #[inline]
    ...
    impl<'a> AppendResponse<'a> {
        ...
        pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
            ...
            if let Some(x) = args.append_responses {
                builder.add_append_responses(x);
            }
        ...
        pub fn append_responses(
            &self,
        ) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<AppendResult<'a>>>>
        {
            // Safety:
            // Created from valid Table for this object
            // which contains a valid value in this slot
            unsafe {
                self._tab.get::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<AppendResult>>,
                >>(AppendResponse::VT_APPEND_RESPONSES, None)
            }
        }
        #[inline]
        pub fn error_code(&self) -> ErrorCode {
            ...
            unsafe {
                self._tab
                    .get::<ErrorCode>(AppendResponse::VT_ERROR_CODE, Some(ErrorCode::NONE))
                    .unwrap()
            }
        }
        #[inline]
        pub fn error_message(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(
                    AppendResponse::VT_ERROR_MESSAGE,
                    None,
                )
            }
        }
    ...
    impl flatbuffers::Verifiable for AppendResponse<'_> {
        ...
        fn run_verifier(
            ...
            v.visit_table(pos)?
                ...
                .visit_field::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<AppendResult>>,
                >>("append_responses", Self::VT_APPEND_RESPONSES, false)?
                .visit_field::<ErrorCode>("error_code", Self::VT_ERROR_CODE, false)?
                .visit_field::<flatbuffers::ForwardsUOffset<&str>>(
                    "error_message",
                    Self::VT_ERROR_MESSAGE,
    ...
    pub struct AppendResponseArgs<'a> {
        ...
        pub append_responses: Option<
            flatbuffers::WIPOffset<
                flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<AppendResult<'a>>>,
            >,
        >,
        pub error_code: ErrorCode,
        pub error_message: Option<flatbuffers::WIPOffset<&'a str>>,
    ...
    impl<'a: 'b, 'b> AppendResponseBuilder<'a, 'b> {
        ...
        #[inline]
        pub fn add_append_responses(
            &mut self,
            append_responses: flatbuffers::WIPOffset<
                flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<AppendResult<'b>>>,
            >,
        ) {
            self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
                AppendResponse::VT_APPEND_RESPONSES,
                append_responses,
            );
        }
        #[inline]
    ...
    impl<'a> AppendResult<'a> {
        ...
        pub fn stream_id(&self) -> i64 {
            ...
            unsafe {
                self._tab
                    .get::<i64>(AppendResult::VT_STREAM_ID, Some(0))
                    .unwrap()
            }
        }
        #[inline]
        pub fn request_index(&self) -> i32 {
            ...
            unsafe {
                self._tab
                    .get::<i32>(AppendResult::VT_REQUEST_INDEX, Some(0))
                    .unwrap()
            }
        }
        #[inline]
        pub fn base_offset(&self) -> i64 {
            ...
            unsafe {
                self._tab
                    .get::<i64>(AppendResult::VT_BASE_OFFSET, Some(0))
                    .unwrap()
            }
        }
        #[inline]
        pub fn stream_append_time_ms(&self) -> i64 {
            ...
            unsafe {
                self._tab
                    .get::<i64>(AppendResult::VT_STREAM_APPEND_TIME_MS, Some(0))
                    .unwrap()
            }
        }
        #[inline]
        pub fn error_code(&self) -> ErrorCode {
            ...
            unsafe {
                self._tab
                    .get::<ErrorCode>(AppendResult::VT_ERROR_CODE, Some(ErrorCode::NONE))
                    .unwrap()
            }
        }
        #[inline]
        pub fn error_message(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<&str>>(AppendResult::VT_ERROR_MESSAGE, None)
            }
        }
    }
    ...
    impl flatbuffers::Verifiable for AppendResult<'_> {
        ...
        fn run_verifier(
            ...
            v.visit_table(pos)?
                ...
                .visit_field::<i64>(
                    "stream_append_time_ms",
                    Self::VT_STREAM_APPEND_TIME_MS,
                    false,
                )?
                .visit_field::<ErrorCode>("error_code", Self::VT_ERROR_CODE, false)?
                .visit_field::<flatbuffers::ForwardsUOffset<&str>>(
    ...
    impl<'a: 'b, 'b> AppendResultBuilder<'a, 'b> {
        ...
        pub fn add_stream_id(&mut self, stream_id: i64) {
            self.fbb_
                .push_slot::<i64>(AppendResult::VT_STREAM_ID, stream_id, 0);
        }
        #[inline]
        pub fn add_request_index(&mut self, request_index: i32) {
            self.fbb_
                .push_slot::<i32>(AppendResult::VT_REQUEST_INDEX, request_index, 0);
        }
        #[inline]
        pub fn add_base_offset(&mut self, base_offset: i64) {
            self.fbb_
                .push_slot::<i64>(AppendResult::VT_BASE_OFFSET, base_offset, 0);
        }
        #[inline]
        pub fn add_stream_append_time_ms(&mut self, stream_append_time_ms: i64) {
            self.fbb_.push_slot::<i64>(
                AppendResult::VT_STREAM_APPEND_TIME_MS,
                stream_append_time_ms,
                0,
            );
        }
    ...
    impl<'a> FetchRequest<'a> {
        ...
        pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
            ...
            if let Some(x) = args.fetch_requests {
                builder.add_fetch_requests(x);
            }
        ...
        pub fn fetch_requests(
            &self,
        ) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<FetchInfo<'a>>>> {
            // Safety:
            // Created from valid Table for this object
            // which contains a valid value in this slot
            unsafe {
                self._tab.get::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<FetchInfo>>,
                >>(FetchRequest::VT_FETCH_REQUESTS, None)
            }
        }
    }
    ...
    impl flatbuffers::Verifiable for FetchRequest<'_> {
        ...
        fn run_verifier(
            ...
            v.visit_table(pos)?
                ...
                .visit_field::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<FetchInfo>>,
                >>("fetch_requests", Self::VT_FETCH_REQUESTS, false)?
                .finish();
            Ok(())
        }
    }
    pub struct FetchRequestArgs<'a> {
        pub max_wait_ms: i32,
        pub min_bytes: i32,
        pub fetch_requests: Option<
            flatbuffers::WIPOffset<
                flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<FetchInfo<'a>>>,
            >,
        >,
    }
    ...
    impl<'a: 'b, 'b> FetchRequestBuilder<'a, 'b> {
        ...
        #[inline]
        pub fn add_fetch_requests(
            &mut self,
            fetch_requests: flatbuffers::WIPOffset<
                flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<FetchInfo<'b>>>,
            >,
        ) {
            self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
                FetchRequest::VT_FETCH_REQUESTS,
                fetch_requests,
            );
        }
        #[inline]
    ...
    impl<'a> FetchInfo<'a> {
        ...
        pub fn stream_id(&self) -> i64 {
            ...
            unsafe {
                self._tab
                    .get::<i64>(FetchInfo::VT_STREAM_ID, Some(0))
                    .unwrap()
            }
        }
        #[inline]
        pub fn request_index(&self) -> i32 {
            ...
            unsafe {
                self._tab
                    .get::<i32>(FetchInfo::VT_REQUEST_INDEX, Some(0))
                    .unwrap()
            }
        }
        #[inline]
        pub fn fetch_offset(&self) -> i64 {
            ...
            unsafe {
                self._tab
                    .get::<i64>(FetchInfo::VT_FETCH_OFFSET, Some(0))
                    .unwrap()
            }
        }
        #[inline]
        pub fn batch_max_bytes(&self) -> i32 {
            ...
            unsafe {
                self._tab
                    .get::<i32>(FetchInfo::VT_BATCH_MAX_BYTES, Some(0))
                    .unwrap()
            }
        }
    }
    ...
    impl<'a: 'b, 'b> FetchInfoBuilder<'a, 'b> {
        ...
        pub fn add_stream_id(&mut self, stream_id: i64) {
            self.fbb_
                .push_slot::<i64>(FetchInfo::VT_STREAM_ID, stream_id, 0);
        }
        #[inline]
        pub fn add_request_index(&mut self, request_index: i32) {
            self.fbb_
                .push_slot::<i32>(FetchInfo::VT_REQUEST_INDEX, request_index, 0);
        }
        #[inline]
        pub fn add_fetch_offset(&mut self, fetch_offset: i64) {
            self.fbb_
                .push_slot::<i64>(FetchInfo::VT_FETCH_OFFSET, fetch_offset, 0);
        }
        #[inline]
        pub fn add_batch_max_bytes(&mut self, batch_max_bytes: i32) {
            self.fbb_
                .push_slot::<i32>(FetchInfo::VT_BATCH_MAX_BYTES, batch_max_bytes, 0);
        }
        #[inline]
    ...
    impl<'a> FetchResponse<'a> {
        ...
        pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
            ...
            if let Some(x) = args.fetch_responses {
                builder.add_fetch_responses(x);
            }
            builder.add_throttle_time_ms(args.throttle_time_ms);
            builder.add_error_code(args.error_code);
            builder.finish()
        ...
        #[inline]
        pub fn fetch_responses(
            &self,
        ) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<FetchResult<'a>>>>
        {
            // Safety:
            // Created from valid Table for this object
            // which contains a valid value in this slot
            unsafe {
                self._tab.get::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<FetchResult>>,
                >>(FetchResponse::VT_FETCH_RESPONSES, None)
            }
        }
        #[inline]
        pub fn error_code(&self) -> ErrorCode {
            ...
            unsafe {
                self._tab
                    .get::<ErrorCode>(FetchResponse::VT_ERROR_CODE, Some(ErrorCode::NONE))
                    .unwrap()
            }
        }
        #[inline]
        pub fn error_message(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(
                    FetchResponse::VT_ERROR_MESSAGE,
                    None,
                )
            }
        }
    ...
    impl flatbuffers::Verifiable for FetchResponse<'_> {
        ...
        fn run_verifier(
            ...
            v.visit_table(pos)?
                .visit_field::<i32>("throttle_time_ms", Self::VT_THROTTLE_TIME_MS, false)?
                .visit_field::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<FetchResult>>,
                >>("fetch_responses", Self::VT_FETCH_RESPONSES, false)?
                .visit_field::<ErrorCode>("error_code", Self::VT_ERROR_CODE, false)?
                .visit_field::<flatbuffers::ForwardsUOffset<&str>>(
                    "error_message",
                    Self::VT_ERROR_MESSAGE,
    ...
    pub struct FetchResponseArgs<'a> {
        pub throttle_time_ms: i32,
        pub fetch_responses: Option<
            flatbuffers::WIPOffset<
                flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<FetchResult<'a>>>,
            >,
        >,
        pub error_code: ErrorCode,
        pub error_message: Option<flatbuffers::WIPOffset<&'a str>>,
    ...
    impl<'a: 'b, 'b> FetchResponseBuilder<'a, 'b> {
        ...
        #[inline]
        pub fn add_fetch_responses(
            &mut self,
            fetch_responses: flatbuffers::WIPOffset<
                flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<FetchResult<'b>>>,
            >,
        ) {
            self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
                FetchResponse::VT_FETCH_RESPONSES,
                fetch_responses,
            );
        }
        #[inline]
    ...
    impl<'a> FetchResult<'a> {
        ...
        pub fn stream_id(&self) -> i64 {
            ...
            unsafe {
                self._tab
                    .get::<i64>(FetchResult::VT_STREAM_ID, Some(0))
                    .unwrap()
            }
        }
        #[inline]
        pub fn request_index(&self) -> i32 {
            ...
            unsafe {
                self._tab
                    .get::<i32>(FetchResult::VT_REQUEST_INDEX, Some(0))
                    .unwrap()
            }
        }
        #[inline]
        pub fn error_code(&self) -> ErrorCode {
            ...
            unsafe {
                self._tab
                    .get::<ErrorCode>(FetchResult::VT_ERROR_CODE, Some(ErrorCode::NONE))
                    .unwrap()
            }
        }
        #[inline]
        pub fn error_message(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<&str>>(FetchResult::VT_ERROR_MESSAGE, None)
            }
        }
        #[inline]
        pub fn batch_length(&self) -> i32 {
            ...
            unsafe {
                self._tab
                    .get::<i32>(FetchResult::VT_BATCH_LENGTH, Some(0))
                    .unwrap()
            }
        }
    }
    ...
    impl<'a: 'b, 'b> FetchResultBuilder<'a, 'b> {
        ...
        pub fn add_stream_id(&mut self, stream_id: i64) {
            self.fbb_
                .push_slot::<i64>(FetchResult::VT_STREAM_ID, stream_id, 0);
        }
        #[inline]
        pub fn add_request_index(&mut self, request_index: i32) {
            self.fbb_
                .push_slot::<i32>(FetchResult::VT_REQUEST_INDEX, request_index, 0);
        }
        #[inline]
        pub fn add_error_code(&mut self, error_code: ErrorCode) {
            self.fbb_.push_slot::<ErrorCode>(
                FetchResult::VT_ERROR_CODE,
                error_code,
                ErrorCode::NONE,
            );
        }
        ...
        pub fn add_batch_length(&mut self, batch_length: i32) {
            self.fbb_
                .push_slot::<i32>(FetchResult::VT_BATCH_LENGTH, batch_length, 0);
        }
        #[inline]
    ...
    impl<'a> RangeOwner<'a> {
        ...
        pub fn data_node(&self) -> Option<DataNode<'a>> {
            ...
            unsafe {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<DataNode>>(RangeOwner::VT_DATA_NODE, None)
            }
        }
        #[inline]
        pub fn stream_id(&self) -> i64 {
            ...
            unsafe {
                self._tab
                    .get::<i64>(RangeOwner::VT_STREAM_ID, Some(0))
                    .unwrap()
            }
        }
    }
    ...
    impl<'a: 'b, 'b> RangeOwnerBuilder<'a, 'b> {
        ...
        pub fn add_stream_id(&mut self, stream_id: i64) {
            self.fbb_
                .push_slot::<i64>(RangeOwner::VT_STREAM_ID, stream_id, 0);
        }
        #[inline]
    ...
    impl<'a> ListRangesRequest<'a> {
        ...
        pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
            ...
            if let Some(x) = args.range_owners {
                builder.add_range_owners(x);
            }
            builder.add_timeout_ms(args.timeout_ms);
            builder.finish()
        }
        ...
        pub fn timeout_ms(&self) -> i32 {
            ...
            unsafe {
                self._tab
                    .get::<i32>(ListRangesRequest::VT_TIMEOUT_MS, Some(0))
                    .unwrap()
            }
        }
        #[inline]
        pub fn range_owners(
            &self,
        ) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<RangeOwner<'a>>>> {
            // Safety:
            // Created from valid Table for this object
            // which contains a valid value in this slot
            unsafe {
                self._tab.get::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<RangeOwner>>,
                >>(ListRangesRequest::VT_RANGE_OWNERS, None)
            }
        }
    }
    ...
    impl flatbuffers::Verifiable for ListRangesRequest<'_> {
        ...
        fn run_verifier(
            ...
            v.visit_table(pos)?
                .visit_field::<i32>("timeout_ms", Self::VT_TIMEOUT_MS, false)?
                .visit_field::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<RangeOwner>>,
                >>("range_owners", Self::VT_RANGE_OWNERS, false)?
                .finish();
            Ok(())
        }
    }
    pub struct ListRangesRequestArgs<'a> {
        pub timeout_ms: i32,
        pub range_owners: Option<
            flatbuffers::WIPOffset<
                flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<RangeOwner<'a>>>,
            >,
        >,
    }
    ...
    impl<'a: 'b, 'b> ListRangesRequestBuilder<'a, 'b> {
        ...
        pub fn add_timeout_ms(&mut self, timeout_ms: i32) {
            self.fbb_
                .push_slot::<i32>(ListRangesRequest::VT_TIMEOUT_MS, timeout_ms, 0);
        }
        #[inline]
        pub fn add_range_owners(
            &mut self,
            range_owners: flatbuffers::WIPOffset<
                flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<RangeOwner<'b>>>,
            >,
        ) {
            self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
                ListRangesRequest::VT_RANGE_OWNERS,
                range_owners,
            );
        }
        #[inline]
    ...
    impl<'a> ListRangesResponse<'a> {
        ...
        pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
            ...
            if let Some(x) = args.list_responses {
                builder.add_list_responses(x);
            }
            builder.add_throttle_time_ms(args.throttle_time_ms);
            builder.add_error_code(args.error_code);
            builder.finish()
        ...
        pub fn throttle_time_ms(&self) -> i32 {
            ...
            unsafe {
                self._tab
                    .get::<i32>(ListRangesResponse::VT_THROTTLE_TIME_MS, Some(0))
                    .unwrap()
            }
        }
        #[inline]
        pub fn list_responses(
            &self,
        ) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<ListRangesResult<'a>>>>
        {
            // Safety:
            // Created from valid Table for this object
            // which contains a valid value in this slot
            unsafe {
                self._tab.get::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<ListRangesResult>>,
                >>(ListRangesResponse::VT_LIST_RESPONSES, None)
            }
        }
        #[inline]
        pub fn error_code(&self) -> ErrorCode {
            ...
            unsafe {
                self._tab
                    .get::<ErrorCode>(ListRangesResponse::VT_ERROR_CODE, Some(ErrorCode::NONE))
                    .unwrap()
            }
        }
        #[inline]
        pub fn error_message(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(
                    ListRangesResponse::VT_ERROR_MESSAGE,
                    None,
                )
            }
        }
    ...
    impl flatbuffers::Verifiable for ListRangesResponse<'_> {
        ...
        fn run_verifier(
            ...
            v.visit_table(pos)?
                .visit_field::<i32>("throttle_time_ms", Self::VT_THROTTLE_TIME_MS, false)?
                .visit_field::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<ListRangesResult>>,
                >>("list_responses", Self::VT_LIST_RESPONSES, false)?
                .visit_field::<ErrorCode>("error_code", Self::VT_ERROR_CODE, false)?
                .visit_field::<flatbuffers::ForwardsUOffset<&str>>(
                    "error_message",
                    Self::VT_ERROR_MESSAGE,
    ...
    pub struct ListRangesResponseArgs<'a> {
        pub throttle_time_ms: i32,
        pub list_responses: Option<
            flatbuffers::WIPOffset<
                flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<ListRangesResult<'a>>>,
            >,
        >,
        pub error_code: ErrorCode,
        pub error_message: Option<flatbuffers::WIPOffset<&'a str>>,
    ...
    impl<'a: 'b, 'b> ListRangesResponseBuilder<'a, 'b> {
        ...
        pub fn add_throttle_time_ms(&mut self, throttle_time_ms: i32) {
            self.fbb_.push_slot::<i32>(
                ListRangesResponse::VT_THROTTLE_TIME_MS,
                throttle_time_ms,
                0,
            );
        }
        #[inline]
        pub fn add_list_responses(
            &mut self,
            list_responses: flatbuffers::WIPOffset<
                flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<ListRangesResult<'b>>>,
            >,
        ) {
            self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
                ListRangesResponse::VT_LIST_RESPONSES,
                list_responses,
            );
        }
        #[inline]
        pub fn add_error_code(&mut self, error_code: ErrorCode) {
            self.fbb_.push_slot::<ErrorCode>(
                ListRangesResponse::VT_ERROR_CODE,
                error_code,
                ErrorCode::NONE,
            );
        }
    ...
    impl<'a> ListRangesResult<'a> {
        ...
        pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
            ...
            if let Some(x) = args.range_owner {
                builder.add_range_owner(x);
            }
            builder.add_error_code(args.error_code);
            builder.finish()
        }
        ...
        pub fn range_owner(&self) -> Option<RangeOwner<'a>> {
            ...
            // which contains a valid value in this slot
            unsafe {
                self._tab.get::<flatbuffers::ForwardsUOffset<RangeOwner>>(
                    ListRangesResult::VT_RANGE_OWNER,
                    None,
                )
            }
        }
        ...
        pub fn error_code(&self) -> ErrorCode {
            ...
            unsafe {
                self._tab
                    .get::<ErrorCode>(ListRangesResult::VT_ERROR_CODE, Some(ErrorCode::NONE))
                    .unwrap()
            }
        }
        #[inline]
        pub fn error_message(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(
                    ListRangesResult::VT_ERROR_MESSAGE,
                    None,
                )
            }
        }
        ...
        pub fn ranges(
            &self,
        ) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Range<'a>>>> {
            // Safety:
            // Created from valid Table for this object
            // which contains a valid value in this slot
            unsafe {
                ...
                >>(ListRangesResult::VT_RANGES, None)
            }
        }
    }
    ...
    impl flatbuffers::Verifiable for ListRangesResult<'_> {
        ...
        fn run_verifier(
            ...
            use self::flatbuffers::Verifiable;
            v.visit_table(pos)?
                .visit_field::<flatbuffers::ForwardsUOffset<RangeOwner>>(
                    "range_owner",
                    Self::VT_RANGE_OWNER,
                    false,
                )?
    ...
    impl<'a: 'b, 'b> ListRangesResultBuilder<'a, 'b> {
        ...
        pub fn add_range_owner(&mut self, range_owner: flatbuffers::WIPOffset<RangeOwner<'b>>) {
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<RangeOwner>>(
                    ListRangesResult::VT_RANGE_OWNER,
                    range_owner,
                );
        }
        ...
        pub fn add_error_code(&mut self, error_code: ErrorCode) {
            self.fbb_.push_slot::<ErrorCode>(
                ListRangesResult::VT_ERROR_CODE,
                error_code,
                ErrorCode::NONE,
            );
        }
        ...
        pub fn add_ranges(
            ...
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(ListRangesResult::VT_RANGES, ranges);
        }
        #[inline]
        pub fn new(
            _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>,
        ) -> ListRangesResultBuilder<'a, 'b> {
            let start = _fbb.start_table();
    ...
    impl<'a> Range<'a> {
        ...
        pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
            ...
            builder.add_stream_id(args.stream_id);
            if let Some(x) = args.replica_nodes {
                builder.add_replica_nodes(x);
            }
        ...
        pub fn range_index(&self) -> i32 {
            ...
            unsafe {
                self._tab
                    .get::<i32>(Range::VT_RANGE_INDEX, Some(0))
                    .unwrap()
            }
        }
        #[inline]
        pub fn start_offset(&self) -> i64 {
            ...
            unsafe {
                self._tab
                    .get::<i64>(Range::VT_START_OFFSET, Some(0))
                    .unwrap()
            }
        }
        #[inline]
        ...
        pub fn next_offset(&self) -> i64 {
            ...
            unsafe {
                self._tab
                    .get::<i64>(Range::VT_NEXT_OFFSET, Some(0))
                    .unwrap()
            }
        }
        #[inline]
        pub fn replica_nodes(
            &self,
        ) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<ReplicaNode<'a>>>>
        {
            // Safety:
            // Created from valid Table for this object
            // which contains a valid value in this slot
            unsafe {
                self._tab.get::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<ReplicaNode>>,
                >>(Range::VT_REPLICA_NODES, None)
            }
        }
    }
    ...
    impl flatbuffers::Verifiable for Range<'_> {
        ...
        fn run_verifier(
            ...
            v.visit_table(pos)?
                ...
                .visit_field::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<ReplicaNode>>,
                >>("replica_nodes", Self::VT_REPLICA_NODES, false)?
                .finish();
            Ok(())
        }
    }
    pub struct RangeArgs<'a> {
        ...
        pub end_offset: i64,
        pub next_offset: i64,
        pub replica_nodes: Option<
            flatbuffers::WIPOffset<
                flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<ReplicaNode<'a>>>,
            >,
        >,
    }
    ...
    impl<'a: 'b, 'b> RangeBuilder<'a, 'b> {
        ...
        pub fn add_stream_id(&mut self, stream_id: i64) {
            self.fbb_
                .push_slot::<i64>(Range::VT_STREAM_ID, stream_id, 0);
        }
        #[inline]
        pub fn add_range_index(&mut self, range_index: i32) {
            self.fbb_
                .push_slot::<i32>(Range::VT_RANGE_INDEX, range_index, 0);
        }
        #[inline]
        pub fn add_start_offset(&mut self, start_offset: i64) {
            self.fbb_
                .push_slot::<i64>(Range::VT_START_OFFSET, start_offset, 0);
        }
        #[inline]
        pub fn add_end_offset(&mut self, end_offset: i64) {
            self.fbb_
                .push_slot::<i64>(Range::VT_END_OFFSET, end_offset, 0);
        }
        #[inline]
        pub fn add_next_offset(&mut self, next_offset: i64) {
            self.fbb_
                .push_slot::<i64>(Range::VT_NEXT_OFFSET, next_offset, 0);
        }
        #[inline]
        pub fn add_replica_nodes(
            &mut self,
            replica_nodes: flatbuffers::WIPOffset<
                flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<ReplicaNode<'b>>>,
            >,
        ) {
            self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
                Range::VT_REPLICA_NODES,
                replica_nodes,
            );
        }
        #[inline]
    ...
    impl<'a> ReplicaNode<'a> {
        ...
        pub fn data_node(&self) -> Option<DataNode<'a>> {
            ...
            unsafe {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<DataNode>>(ReplicaNode::VT_DATA_NODE, None)
            }
        }
        #[inline]
        pub fn is_primary(&self) -> bool {
            ...
            unsafe {
                self._tab
                    .get::<bool>(ReplicaNode::VT_IS_PRIMARY, Some(false))
                    .unwrap()
            }
        }
    }
    ...
    impl<'a: 'b, 'b> ReplicaNodeBuilder<'a, 'b> {
        ...
        pub fn add_is_primary(&mut self, is_primary: bool) {
            self.fbb_
                .push_slot::<bool>(ReplicaNode::VT_IS_PRIMARY, is_primary, false);
        }
        #[inline]
    ...
    impl<'a> SealRangesRequest<'a> {
        ...
        pub fn timeout_ms(&self) -> i32 {
            ...
            unsafe {
                self._tab
                    .get::<i32>(SealRangesRequest::VT_TIMEOUT_MS, Some(0))
                    .unwrap()
            }
        }
        #[inline]
        pub fn ranges(
            &self,
        ) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<RangeId<'a>>>> {
            // Safety:
            // Created from valid Table for this object
            // which contains a valid value in this slot
            unsafe {
                self._tab.get::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<RangeId>>,
                >>(SealRangesRequest::VT_RANGES, None)
            }
        }
    }
    ...
    impl flatbuffers::Verifiable for SealRangesRequest<'_> {
        ...
        fn run_verifier(
            ...
            v.visit_table(pos)?
                .visit_field::<i32>("timeout_ms", Self::VT_TIMEOUT_MS, false)?
                .visit_field::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<RangeId>>,
                >>("ranges", Self::VT_RANGES, false)?
                .finish();
            Ok(())
        }
    ...
    pub struct SealRangesRequestArgs<'a> {
        ...
        pub ranges: Option<
            flatbuffers::WIPOffset<
                flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<RangeId<'a>>>,
            >,
        >,
    }
    ...
    impl<'a: 'b, 'b> SealRangesRequestBuilder<'a, 'b> {
        ...
        pub fn add_timeout_ms(&mut self, timeout_ms: i32) {
            self.fbb_
                .push_slot::<i32>(SealRangesRequest::VT_TIMEOUT_MS, timeout_ms, 0);
        }
        #[inline]
        pub fn add_ranges(
            &mut self,
            ranges: flatbuffers::WIPOffset<
                flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<RangeId<'b>>>,
            >,
        ) {
            self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
                SealRangesRequest::VT_RANGES,
                ranges,
            );
        }
        #[inline]
    ...
    impl<'a> RangeId<'a> {
        ...
        pub fn stream_id(&self) -> i64 {
            ...
            unsafe {
                self._tab
                    .get::<i64>(RangeId::VT_STREAM_ID, Some(0))
                    .unwrap()
            }
        }
        #[inline]
        pub fn range_index(&self) -> i32 {
            ...
            unsafe {
                self._tab
                    .get::<i32>(RangeId::VT_RANGE_INDEX, Some(0))
                    .unwrap()
            }
        }
    }
    ...
    impl<'a: 'b, 'b> RangeIdBuilder<'a, 'b> {
        ...
        pub fn add_stream_id(&mut self, stream_id: i64) {
            self.fbb_
                .push_slot::<i64>(RangeId::VT_STREAM_ID, stream_id, 0);
        }
        #[inline]
        pub fn add_range_index(&mut self, range_index: i32) {
            self.fbb_
                .push_slot::<i32>(RangeId::VT_RANGE_INDEX, range_index, 0);
        }
        #[inline]
    ...
    impl<'a> SealRangesResponse<'a> {
        ...
        pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
            ...
            if let Some(x) = args.seal_responses {
                builder.add_seal_responses(x);
            }
            builder.add_throttle_time_ms(args.throttle_time_ms);
            builder.add_error_code(args.error_code);
            builder.finish()
        ...
        pub fn throttle_time_ms(&self) -> i32 {
            ...
            unsafe {
                self._tab
                    .get::<i32>(SealRangesResponse::VT_THROTTLE_TIME_MS, Some(0))
                    .unwrap()
            }
        }
        #[inline]
        pub fn seal_responses(
            &self,
        ) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<SealRangesResult<'a>>>>
        {
            // Safety:
            // Created from valid Table for this object
            // which contains a valid value in this slot
            unsafe {
                self._tab.get::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<SealRangesResult>>,
                >>(SealRangesResponse::VT_SEAL_RESPONSES, None)
            }
        }
        #[inline]
        pub fn error_code(&self) -> ErrorCode {
            ...
            unsafe {
                self._tab
                    .get::<ErrorCode>(SealRangesResponse::VT_ERROR_CODE, Some(ErrorCode::NONE))
                    .unwrap()
            }
        }
        #[inline]
        pub fn error_message(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(
                    SealRangesResponse::VT_ERROR_MESSAGE,
                    None,
                )
            }
        }
    ...
    impl flatbuffers::Verifiable for SealRangesResponse<'_> {
        ...
        fn run_verifier(
            ...
            v.visit_table(pos)?
                .visit_field::<i32>("throttle_time_ms", Self::VT_THROTTLE_TIME_MS, false)?
                .visit_field::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<SealRangesResult>>,
                >>("seal_responses", Self::VT_SEAL_RESPONSES, false)?
                .visit_field::<ErrorCode>("error_code", Self::VT_ERROR_CODE, false)?
                .visit_field::<flatbuffers::ForwardsUOffset<&str>>(
                    "error_message",
                    Self::VT_ERROR_MESSAGE,
    ...
    pub struct SealRangesResponseArgs<'a> {
        pub throttle_time_ms: i32,
        pub seal_responses: Option<
            flatbuffers::WIPOffset<
                flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<SealRangesResult<'a>>>,
            >,
        >,
        pub error_code: ErrorCode,
        pub error_message: Option<flatbuffers::WIPOffset<&'a str>>,
    ...
    impl<'a: 'b, 'b> SealRangesResponseBuilder<'a, 'b> {
        ...
        pub fn add_throttle_time_ms(&mut self, throttle_time_ms: i32) {
            self.fbb_.push_slot::<i32>(
                SealRangesResponse::VT_THROTTLE_TIME_MS,
                throttle_time_ms,
                0,
            );
        }
        #[inline]
        pub fn add_seal_responses(
            &mut self,
            seal_responses: flatbuffers::WIPOffset<
                flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<SealRangesResult<'b>>>,
            >,
        ) {
            self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
                SealRangesResponse::VT_SEAL_RESPONSES,
                seal_responses,
            );
        }
        #[inline]
        pub fn add_error_code(&mut self, error_code: ErrorCode) {
            self.fbb_.push_slot::<ErrorCode>(
                SealRangesResponse::VT_ERROR_CODE,
                error_code,
                ErrorCode::NONE,
            );
        }
    ...
    impl<'a> SealRangesResult<'a> {
        ...
        pub fn stream_id(&self) -> i64 {
            ...
            unsafe {
                self._tab
                    .get::<i64>(SealRangesResult::VT_STREAM_ID, Some(0))
                    .unwrap()
            }
        }
        #[inline]
        pub fn error_code(&self) -> ErrorCode {
            ...
            unsafe {
                self._tab
                    .get::<ErrorCode>(SealRangesResult::VT_ERROR_CODE, Some(ErrorCode::NONE))
                    .unwrap()
            }
        }
        #[inline]
        pub fn error_message(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(
                    SealRangesResult::VT_ERROR_MESSAGE,
                    None,
                )
            }
        }
        ...
        pub fn ranges(
            ...
            unsafe {
                self._tab.get::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Range>>,
                >>(SealRangesResult::VT_RANGES, None)
            }
        }
    }
    ...
    impl<'a: 'b, 'b> SealRangesResultBuilder<'a, 'b> {
        ...
        pub fn add_stream_id(&mut self, stream_id: i64) {
            self.fbb_
                .push_slot::<i64>(SealRangesResult::VT_STREAM_ID, stream_id, 0);
        }
        #[inline]
        pub fn add_error_code(&mut self, error_code: ErrorCode) {
            self.fbb_.push_slot::<ErrorCode>(
                SealRangesResult::VT_ERROR_CODE,
                error_code,
                ErrorCode::NONE,
            );
        }
        ...
        pub fn add_ranges(
            ...
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(SealRangesResult::VT_RANGES, ranges);
        }
        #[inline]
        pub fn new(
            _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>,
        ) -> SealRangesResultBuilder<'a, 'b> {
            let start = _fbb.start_table();
    ...
    impl<'a> SyncRangesRequest<'a> {
        ...
        pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
            ...
            if let Some(x) = args.stream_ranges {
                builder.add_stream_ranges(x);
            }
            builder.add_timeout_ms(args.timeout_ms);
            builder.finish()
        }
        ...
        pub fn timeout_ms(&self) -> i32 {
            ...
            unsafe {
                self._tab
                    .get::<i32>(SyncRangesRequest::VT_TIMEOUT_MS, Some(0))
                    .unwrap()
            }
        }
        #[inline]
        pub fn stream_ranges(
            &self,
        ) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<StreamRanges<'a>>>>
        {
            // Safety:
            // Created from valid Table for this object
            // which contains a valid value in this slot
            unsafe {
                self._tab.get::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<StreamRanges>>,
                >>(SyncRangesRequest::VT_STREAM_RANGES, None)
            }
        }
    }
    ...
    impl flatbuffers::Verifiable for SyncRangesRequest<'_> {
        ...
        fn run_verifier(
            ...
            v.visit_table(pos)?
                .visit_field::<i32>("timeout_ms", Self::VT_TIMEOUT_MS, false)?
                .visit_field::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<StreamRanges>>,
                >>("stream_ranges", Self::VT_STREAM_RANGES, false)?
                .finish();
            Ok(())
        }
    }
    pub struct SyncRangesRequestArgs<'a> {
        pub timeout_ms: i32,
        pub stream_ranges: Option<
            flatbuffers::WIPOffset<
                flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<StreamRanges<'a>>>,
            >,
        >,
    }
    ...
    impl<'a: 'b, 'b> SyncRangesRequestBuilder<'a, 'b> {
        ...
        pub fn add_timeout_ms(&mut self, timeout_ms: i32) {
            self.fbb_
                .push_slot::<i32>(SyncRangesRequest::VT_TIMEOUT_MS, timeout_ms, 0);
        }
        #[inline]
        pub fn add_stream_ranges(
            &mut self,
            stream_ranges: flatbuffers::WIPOffset<
                flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<StreamRanges<'b>>>,
            >,
        ) {
            self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
                SyncRangesRequest::VT_STREAM_RANGES,
                stream_ranges,
            );
        }
        #[inline]
    ...
    impl<'a> StreamRanges<'a> {
        ...
        pub fn stream_id(&self) -> i64 {
            ...
            unsafe {
                self._tab
                    .get::<i64>(StreamRanges::VT_STREAM_ID, Some(0))
                    .unwrap()
            }
        }
        #[inline]
    ...
    impl<'a: 'b, 'b> StreamRangesBuilder<'a, 'b> {
        ...
        pub fn add_stream_id(&mut self, stream_id: i64) {
            self.fbb_
                .push_slot::<i64>(StreamRanges::VT_STREAM_ID, stream_id, 0);
        }
        #[inline]
        pub fn add_ranges(
            &mut self,
            ...
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(StreamRanges::VT_RANGES, ranges);
        }
        #[inline]
        pub fn new(
            _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>,
        ) -> StreamRangesBuilder<'a, 'b> {
            let start = _fbb.start_table();
            StreamRangesBuilder {
                fbb_: _fbb,
                start_: start,
    ...
    impl<'a> SyncRangesResponse<'a> {
        ...
        pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
            ...
            if let Some(x) = args.sync_responses {
                builder.add_sync_responses(x);
            }
            builder.add_throttle_time_ms(args.throttle_time_ms);
            builder.add_error_code(args.error_code);
            builder.finish()
        ...
        pub fn throttle_time_ms(&self) -> i32 {
            ...
            unsafe {
                self._tab
                    .get::<i32>(SyncRangesResponse::VT_THROTTLE_TIME_MS, Some(0))
                    .unwrap()
            }
        }
        #[inline]
        pub fn sync_responses(
            &self,
        ) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<SyncRangesResult<'a>>>>
        {
            // Safety:
            // Created from valid Table for this object
            // which contains a valid value in this slot
            unsafe {
                self._tab.get::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<SyncRangesResult>>,
                >>(SyncRangesResponse::VT_SYNC_RESPONSES, None)
            }
        }
        #[inline]
        pub fn error_code(&self) -> ErrorCode {
            ...
            unsafe {
                self._tab
                    .get::<ErrorCode>(SyncRangesResponse::VT_ERROR_CODE, Some(ErrorCode::NONE))
                    .unwrap()
            }
        }
        #[inline]
        pub fn error_message(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(
                    SyncRangesResponse::VT_ERROR_MESSAGE,
                    None,
                )
            }
        }
    ...
    impl flatbuffers::Verifiable for SyncRangesResponse<'_> {
        ...
        fn run_verifier(
            ...
            v.visit_table(pos)?
                .visit_field::<i32>("throttle_time_ms", Self::VT_THROTTLE_TIME_MS, false)?
                .visit_field::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<SyncRangesResult>>,
                >>("sync_responses", Self::VT_SYNC_RESPONSES, false)?
                .visit_field::<ErrorCode>("error_code", Self::VT_ERROR_CODE, false)?
                .visit_field::<flatbuffers::ForwardsUOffset<&str>>(
                    "error_message",
                    Self::VT_ERROR_MESSAGE,
    ...
    pub struct SyncRangesResponseArgs<'a> {
        pub throttle_time_ms: i32,
        pub sync_responses: Option<
            flatbuffers::WIPOffset<
                flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<SyncRangesResult<'a>>>,
            >,
        >,
        pub error_code: ErrorCode,
        pub error_message: Option<flatbuffers::WIPOffset<&'a str>>,
    ...
    impl<'a: 'b, 'b> SyncRangesResponseBuilder<'a, 'b> {
        ...
        pub fn add_throttle_time_ms(&mut self, throttle_time_ms: i32) {
            self.fbb_.push_slot::<i32>(
                SyncRangesResponse::VT_THROTTLE_TIME_MS,
                throttle_time_ms,
                0,
            );
        }
        #[inline]
        pub fn add_sync_responses(
            &mut self,
            sync_responses: flatbuffers::WIPOffset<
                flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<SyncRangesResult<'b>>>,
            >,
        ) {
            self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
                SyncRangesResponse::VT_SYNC_RESPONSES,
                sync_responses,
            );
        }
        #[inline]
        pub fn add_error_code(&mut self, error_code: ErrorCode) {
            self.fbb_.push_slot::<ErrorCode>(
                SyncRangesResponse::VT_ERROR_CODE,
                error_code,
                ErrorCode::NONE,
            );
        }
    ...
    impl<'a> SyncRangesResult<'a> {
        ...
        pub fn stream_id(&self) -> i64 {
            ...
            unsafe {
                self._tab
                    .get::<i64>(SyncRangesResult::VT_STREAM_ID, Some(0))
                    .unwrap()
            }
        }
        #[inline]
        pub fn error_code(&self) -> ErrorCode {
            ...
            unsafe {
                self._tab
                    .get::<ErrorCode>(SyncRangesResult::VT_ERROR_CODE, Some(ErrorCode::NONE))
                    .unwrap()
            }
        }
        #[inline]
        pub fn error_message(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(
                    SyncRangesResult::VT_ERROR_MESSAGE,
                    None,
                )
            }
        }
        ...
        pub fn ranges(
            ...
            unsafe {
                self._tab.get::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Range>>,
                >>(SyncRangesResult::VT_RANGES, None)
            }
        }
    }
    ...
    impl<'a: 'b, 'b> SyncRangesResultBuilder<'a, 'b> {
        ...
        pub fn add_stream_id(&mut self, stream_id: i64) {
            self.fbb_
                .push_slot::<i64>(SyncRangesResult::VT_STREAM_ID, stream_id, 0);
        }
        #[inline]
        pub fn add_error_code(&mut self, error_code: ErrorCode) {
            self.fbb_.push_slot::<ErrorCode>(
                SyncRangesResult::VT_ERROR_CODE,
                error_code,
                ErrorCode::NONE,
            );
        }
        ...
        pub fn add_ranges(
            ...
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(SyncRangesResult::VT_RANGES, ranges);
        }
        #[inline]
        pub fn new(
            _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>,
        ) -> SyncRangesResultBuilder<'a, 'b> {
            let start = _fbb.start_table();
    ...
    impl<'a> DescribeRangesRequest<'a> {
        ...
        pub fn timeout_ms(&self) -> i32 {
            ...
            unsafe {
                self._tab
                    .get::<i32>(DescribeRangesRequest::VT_TIMEOUT_MS, Some(0))
                    .unwrap()
            }
        }
        #[inline]
        pub fn ranges(
            ...
            unsafe {
                self._tab.get::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<RangeId>>,
                >>(DescribeRangesRequest::VT_RANGES, None)
            }
        }
    }
    ...
    impl<'a: 'b, 'b> DescribeRangesRequestBuilder<'a, 'b> {
        ...
        pub fn add_timeout_ms(&mut self, timeout_ms: i32) {
            self.fbb_
                .push_slot::<i32>(DescribeRangesRequest::VT_TIMEOUT_MS, timeout_ms, 0);
        }
        #[inline]
        pub fn add_ranges(
            &mut self,
            ...
            self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
                DescribeRangesRequest::VT_RANGES,
                ranges,
            );
        }
        #[inline]
        pub fn new(
            _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>,
        ) -> DescribeRangesRequestBuilder<'a, 'b> {
            let start = _fbb.start_table();
    ...
    impl<'a> DescribeRangesResponse<'a> {
        ...
        pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
            ...
            if let Some(x) = args.describe_responses {
                builder.add_describe_responses(x);
            }
            builder.add_throttle_time_ms(args.throttle_time_ms);
            builder.add_error_code(args.error_code);
            builder.finish()
        ...
        pub fn throttle_time_ms(&self) -> i32 {
            ...
            unsafe {
                self._tab
                    .get::<i32>(DescribeRangesResponse::VT_THROTTLE_TIME_MS, Some(0))
                    .unwrap()
            }
        }
        #[inline]
        pub fn describe_responses(
            &self,
        ) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<DescribeRangeResult<'a>>>>
        {
            // Safety:
            // Created from valid Table for this object
            // which contains a valid value in this slot
            unsafe {
                self._tab.get::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<DescribeRangeResult>>,
                >>(DescribeRangesResponse::VT_DESCRIBE_RESPONSES, None)
            }
        }
        #[inline]
        pub fn error_code(&self) -> ErrorCode {
            ...
            unsafe {
                self._tab
                    .get::<ErrorCode>(DescribeRangesResponse::VT_ERROR_CODE, Some(ErrorCode::NONE))
                    .unwrap()
            }
        }
        #[inline]
        pub fn error_message(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(
                    DescribeRangesResponse::VT_ERROR_MESSAGE,
                    None,
                )
            }
        }
    ...
    impl flatbuffers::Verifiable for DescribeRangesResponse<'_> {
        ...
        fn run_verifier(
            ...
            v.visit_table(pos)?
                .visit_field::<i32>("throttle_time_ms", Self::VT_THROTTLE_TIME_MS, false)?
                .visit_field::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<DescribeRangeResult>>,
                >>("describe_responses", Self::VT_DESCRIBE_RESPONSES, false)?
                .visit_field::<ErrorCode>("error_code", Self::VT_ERROR_CODE, false)?
                .visit_field::<flatbuffers::ForwardsUOffset<&str>>(
                    "error_message",
                    Self::VT_ERROR_MESSAGE,
    ...
    pub struct DescribeRangesResponseArgs<'a> {
        pub throttle_time_ms: i32,
        pub describe_responses: Option<
            flatbuffers::WIPOffset<
                flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<DescribeRangeResult<'a>>>,
            >,
        >,
        pub error_code: ErrorCode,
        pub error_message: Option<flatbuffers::WIPOffset<&'a str>>,
    ...
    impl<'a: 'b, 'b> DescribeRangesResponseBuilder<'a, 'b> {
        ...
        pub fn add_throttle_time_ms(&mut self, throttle_time_ms: i32) {
            self.fbb_.push_slot::<i32>(
                DescribeRangesResponse::VT_THROTTLE_TIME_MS,
                throttle_time_ms,
                0,
            );
        }
        #[inline]
        pub fn add_describe_responses(
            &mut self,
            describe_responses: flatbuffers::WIPOffset<
                flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<DescribeRangeResult<'b>>>,
            >,
        ) {
            self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
                DescribeRangesResponse::VT_DESCRIBE_RESPONSES,
                describe_responses,
            );
        }
        #[inline]
        pub fn add_error_code(&mut self, error_code: ErrorCode) {
            self.fbb_.push_slot::<ErrorCode>(
                DescribeRangesResponse::VT_ERROR_CODE,
                error_code,
                ErrorCode::NONE,
            );
        }
        ...
        pub fn new(
            _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>,
        ) -> DescribeRangesResponseBuilder<'a, 'b> {
            let start = _fbb.start_table();
    ...
    impl<'a> DescribeRangeResult<'a> {
        ...
        pub fn stream_id(&self) -> i64 {
            ...
            unsafe {
                self._tab
                    .get::<i64>(DescribeRangeResult::VT_STREAM_ID, Some(0))
                    .unwrap()
            }
        }
        #[inline]
        pub fn error_code(&self) -> ErrorCode {
            ...
            unsafe {
                self._tab
                    .get::<ErrorCode>(DescribeRangeResult::VT_ERROR_CODE, Some(ErrorCode::NONE))
                    .unwrap()
            }
        }
        #[inline]
        pub fn error_message(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(
                    DescribeRangeResult::VT_ERROR_MESSAGE,
                    None,
                )
            }
        }
        ...
        pub fn ranges(&self) -> Option<Range<'a>> {
            ...
            // which contains a valid value in this slot
            unsafe {
                self._tab.get::<flatbuffers::ForwardsUOffset<Range>>(
                    DescribeRangeResult::VT_RANGES,
                    None,
                )
            }
        }
    ...
    impl flatbuffers::Verifiable for DescribeRangeResult<'_> {
        ...
        fn run_verifier(
            ...
            v.visit_table(pos)?
                ...
                .visit_field::<flatbuffers::ForwardsUOffset<Range>>(
                    "ranges",
                    Self::VT_RANGES,
                    false,
                )?
    ...
    impl<'a: 'b, 'b> DescribeRangeResultBuilder<'a, 'b> {
        ...
        pub fn add_stream_id(&mut self, stream_id: i64) {
            self.fbb_
                .push_slot::<i64>(DescribeRangeResult::VT_STREAM_ID, stream_id, 0);
        }
        #[inline]
        pub fn add_error_code(&mut self, error_code: ErrorCode) {
            self.fbb_.push_slot::<ErrorCode>(
                DescribeRangeResult::VT_ERROR_CODE,
                error_code,
                ErrorCode::NONE,
            );
        }
        ...
        pub fn new(
            _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>,
        ) -> DescribeRangeResultBuilder<'a, 'b> {
            let start = _fbb.start_table();
    ...
    impl<'a> Stream<'a> {
        ...
        pub fn replica_nums(&self) -> i8 {
            ...
            unsafe {
                self._tab
                    .get::<i8>(Stream::VT_REPLICA_NUMS, Some(0))
                    .unwrap()
            }
        }
        #[inline]
        pub fn retention_period_ms(&self) -> i32 {
            ...
            unsafe {
                self._tab
                    .get::<i32>(Stream::VT_RETENTION_PERIOD_MS, Some(0))
                    .unwrap()
            }
        }
    }
    ...
    impl<'a: 'b, 'b> StreamBuilder<'a, 'b> {
        ...
        pub fn add_stream_id(&mut self, stream_id: i64) {
            self.fbb_
                .push_slot::<i64>(Stream::VT_STREAM_ID, stream_id, 0);
        }
        #[inline]
        pub fn add_replica_nums(&mut self, replica_nums: i8) {
            self.fbb_
                .push_slot::<i8>(Stream::VT_REPLICA_NUMS, replica_nums, 0);
        }
        #[inline]
        pub fn add_retention_period_ms(&mut self, retention_period_ms: i32) {
            self.fbb_
                .push_slot::<i32>(Stream::VT_RETENTION_PERIOD_MS, retention_period_ms, 0);
        }
        #[inline]
    ...
    impl<'a> CreateStreamsRequest<'a> {
        ...
        pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
            ...
            if let Some(x) = args.stremas {
                builder.add_stremas(x);
            }
            builder.add_timeout_ms(args.timeout_ms);
            builder.finish()
        }
        ...
        pub fn timeout_ms(&self) -> i32 {
            ...
            unsafe {
                self._tab
                    .get::<i32>(CreateStreamsRequest::VT_TIMEOUT_MS, Some(0))
                    .unwrap()
            }
        }
        #[inline]
        pub fn stremas(
            &self,
        ) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Stream<'a>>>> {
            // Safety:
            // Created from valid Table for this object
            // which contains a valid value in this slot
            unsafe {
                self._tab.get::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Stream>>,
                >>(CreateStreamsRequest::VT_STREMAS, None)
            }
        }
    }
    ...
    impl flatbuffers::Verifiable for CreateStreamsRequest<'_> {
        ...
        fn run_verifier(
            ...
            v.visit_table(pos)?
                .visit_field::<i32>("timeout_ms", Self::VT_TIMEOUT_MS, false)?
                .visit_field::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<Stream>>,
                >>("stremas", Self::VT_STREMAS, false)?
                .finish();
            Ok(())
        }
    }
    pub struct CreateStreamsRequestArgs<'a> {
        ...
        pub stremas: Option<
            flatbuffers::WIPOffset<
                flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Stream<'a>>>,
            >,
        >,
    }
    ...
    impl<'a: 'b, 'b> CreateStreamsRequestBuilder<'a, 'b> {
        ...
        pub fn add_timeout_ms(&mut self, timeout_ms: i32) {
            self.fbb_
                .push_slot::<i32>(CreateStreamsRequest::VT_TIMEOUT_MS, timeout_ms, 0);
        }
        #[inline]
        pub fn add_stremas(
            &mut self,
            stremas: flatbuffers::WIPOffset<
                flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<Stream<'b>>>,
            >,
        ) {
            self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
                CreateStreamsRequest::VT_STREMAS,
                stremas,
            );
        }
        #[inline]
        pub fn new(
            _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>,
        ) -> CreateStreamsRequestBuilder<'a, 'b> {
            let start = _fbb.start_table();
    ...
    impl<'a> CreateStreamsResponse<'a> {
        ...
        pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
            ...
            if let Some(x) = args.create_responses {
                builder.add_create_responses(x);
            }
            builder.add_throttle_time_ms(args.throttle_time_ms);
            builder.add_error_code(args.error_code);
            builder.finish()
        ...
        pub fn throttle_time_ms(&self) -> i32 {
            ...
            unsafe {
                self._tab
                    .get::<i32>(CreateStreamsResponse::VT_THROTTLE_TIME_MS, Some(0))
                    .unwrap()
            }
        }
        #[inline]
        pub fn create_responses(
            &self,
        ) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<CreateStreamResult<'a>>>>
        {
            // Safety:
            // Created from valid Table for this object
            // which contains a valid value in this slot
            unsafe {
                self._tab.get::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<CreateStreamResult>>,
                >>(CreateStreamsResponse::VT_CREATE_RESPONSES, None)
            }
        }
        #[inline]
        pub fn error_code(&self) -> ErrorCode {
            ...
            unsafe {
                self._tab
                    .get::<ErrorCode>(CreateStreamsResponse::VT_ERROR_CODE, Some(ErrorCode::NONE))
                    .unwrap()
            }
        }
        #[inline]
        pub fn error_message(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(
                    CreateStreamsResponse::VT_ERROR_MESSAGE,
                    None,
                )
            }
        }
    ...
    impl flatbuffers::Verifiable for CreateStreamsResponse<'_> {
        ...
        fn run_verifier(
            ...
            v.visit_table(pos)?
                .visit_field::<i32>("throttle_time_ms", Self::VT_THROTTLE_TIME_MS, false)?
                .visit_field::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<CreateStreamResult>>,
                >>("create_responses", Self::VT_CREATE_RESPONSES, false)?
                .visit_field::<ErrorCode>("error_code", Self::VT_ERROR_CODE, false)?
                .visit_field::<flatbuffers::ForwardsUOffset<&str>>(
                    "error_message",
                    Self::VT_ERROR_MESSAGE,
    ...
    pub struct CreateStreamsResponseArgs<'a> {
        pub throttle_time_ms: i32,
        pub create_responses: Option<
            flatbuffers::WIPOffset<
                flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<CreateStreamResult<'a>>>,
            >,
        >,
        pub error_code: ErrorCode,
        pub error_message: Option<flatbuffers::WIPOffset<&'a str>>,
    ...
    impl<'a: 'b, 'b> CreateStreamsResponseBuilder<'a, 'b> {
        ...
        pub fn add_throttle_time_ms(&mut self, throttle_time_ms: i32) {
            self.fbb_.push_slot::<i32>(
                CreateStreamsResponse::VT_THROTTLE_TIME_MS,
                throttle_time_ms,
                0,
            );
        }
        #[inline]
        pub fn add_create_responses(
            &mut self,
            create_responses: flatbuffers::WIPOffset<
                flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<CreateStreamResult<'b>>>,
            >,
        ) {
            self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
                CreateStreamsResponse::VT_CREATE_RESPONSES,
                create_responses,
            );
        }
        #[inline]
        pub fn add_error_code(&mut self, error_code: ErrorCode) {
            self.fbb_.push_slot::<ErrorCode>(
                CreateStreamsResponse::VT_ERROR_CODE,
                error_code,
                ErrorCode::NONE,
            );
        }
        ...
        pub fn new(
            _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>,
        ) -> CreateStreamsResponseBuilder<'a, 'b> {
            let start = _fbb.start_table();
    ...
    impl<'a> CreateStreamResult<'a> {
        ...
        pub fn error_code(&self) -> ErrorCode {
            ...
            unsafe {
                self._tab
                    .get::<ErrorCode>(CreateStreamResult::VT_ERROR_CODE, Some(ErrorCode::NONE))
                    .unwrap()
            }
        }
        #[inline]
        pub fn error_message(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(
                    CreateStreamResult::VT_ERROR_MESSAGE,
                    None,
                )
            }
        }
    ...
    impl<'a: 'b, 'b> CreateStreamResultBuilder<'a, 'b> {
        ...
        pub fn add_error_code(&mut self, error_code: ErrorCode) {
            self.fbb_.push_slot::<ErrorCode>(
                CreateStreamResult::VT_ERROR_CODE,
                error_code,
                ErrorCode::NONE,
            );
        }
    ...
    impl<'a> DeleteStreamsRequest<'a> {
        ...
        pub fn timeout_ms(&self) -> i32 {
            ...
            unsafe {
                self._tab
                    .get::<i32>(DeleteStreamsRequest::VT_TIMEOUT_MS, Some(0))
                    .unwrap()
            }
        }
        #[inline]
        pub fn streams(
            ...
            unsafe {
                self._tab.get::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Stream>>,
                >>(DeleteStreamsRequest::VT_STREAMS, None)
            }
        }
    }
    ...
    impl<'a: 'b, 'b> DeleteStreamsRequestBuilder<'a, 'b> {
        ...
        pub fn add_timeout_ms(&mut self, timeout_ms: i32) {
            self.fbb_
                .push_slot::<i32>(DeleteStreamsRequest::VT_TIMEOUT_MS, timeout_ms, 0);
        }
        #[inline]
        pub fn add_streams(
            &mut self,
            ...
            self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
                DeleteStreamsRequest::VT_STREAMS,
                streams,
            );
        }
        #[inline]
        pub fn new(
            _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>,
        ) -> DeleteStreamsRequestBuilder<'a, 'b> {
            let start = _fbb.start_table();
    ...
    impl<'a> DeleteStreamsResponse<'a> {
        ...
        pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
            ...
            if let Some(x) = args.delete_responses {
                builder.add_delete_responses(x);
            }
            builder.add_throttle_time_ms(args.throttle_time_ms);
            builder.add_error_code(args.error_code);
            builder.finish()
        ...
        pub fn throttle_time_ms(&self) -> i32 {
            ...
            unsafe {
                self._tab
                    .get::<i32>(DeleteStreamsResponse::VT_THROTTLE_TIME_MS, Some(0))
                    .unwrap()
            }
        }
        #[inline]
        pub fn delete_responses(
            &self,
        ) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<DeleteStreamResult<'a>>>>
        {
            // Safety:
            // Created from valid Table for this object
            // which contains a valid value in this slot
            unsafe {
                self._tab.get::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<DeleteStreamResult>>,
                >>(DeleteStreamsResponse::VT_DELETE_RESPONSES, None)
            }
        }
        #[inline]
        pub fn error_code(&self) -> ErrorCode {
            ...
            unsafe {
                self._tab
                    .get::<ErrorCode>(DeleteStreamsResponse::VT_ERROR_CODE, Some(ErrorCode::NONE))
                    .unwrap()
            }
        }
        #[inline]
        pub fn error_message(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(
                    DeleteStreamsResponse::VT_ERROR_MESSAGE,
                    None,
                )
            }
        }
    ...
    impl flatbuffers::Verifiable for DeleteStreamsResponse<'_> {
        ...
        fn run_verifier(
            ...
            v.visit_table(pos)?
                .visit_field::<i32>("throttle_time_ms", Self::VT_THROTTLE_TIME_MS, false)?
                .visit_field::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<DeleteStreamResult>>,
                >>("delete_responses", Self::VT_DELETE_RESPONSES, false)?
                .visit_field::<ErrorCode>("error_code", Self::VT_ERROR_CODE, false)?
                .visit_field::<flatbuffers::ForwardsUOffset<&str>>(
                    "error_message",
                    Self::VT_ERROR_MESSAGE,
    ...
    pub struct DeleteStreamsResponseArgs<'a> {
        pub throttle_time_ms: i32,
        pub delete_responses: Option<
            flatbuffers::WIPOffset<
                flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<DeleteStreamResult<'a>>>,
            >,
        >,
        pub error_code: ErrorCode,
        pub error_message: Option<flatbuffers::WIPOffset<&'a str>>,
    ...
    impl<'a: 'b, 'b> DeleteStreamsResponseBuilder<'a, 'b> {
        ...
        pub fn add_throttle_time_ms(&mut self, throttle_time_ms: i32) {
            self.fbb_.push_slot::<i32>(
                DeleteStreamsResponse::VT_THROTTLE_TIME_MS,
                throttle_time_ms,
                0,
            );
        }
        #[inline]
        pub fn add_delete_responses(
            &mut self,
            delete_responses: flatbuffers::WIPOffset<
                flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<DeleteStreamResult<'b>>>,
            >,
        ) {
            self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
                DeleteStreamsResponse::VT_DELETE_RESPONSES,
                delete_responses,
            );
        }
        #[inline]
        pub fn add_error_code(&mut self, error_code: ErrorCode) {
            self.fbb_.push_slot::<ErrorCode>(
                DeleteStreamsResponse::VT_ERROR_CODE,
                error_code,
                ErrorCode::NONE,
            );
        }
        ...
        pub fn new(
            _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>,
        ) -> DeleteStreamsResponseBuilder<'a, 'b> {
            let start = _fbb.start_table();
    ...
    impl<'a> DeleteStreamResult<'a> {
        ...
        pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
            ...
            if let Some(x) = args.deleted_stream {
                builder.add_deleted_stream(x);
            }
            builder.add_error_code(args.error_code);
            builder.finish()
        }
        ...
        pub fn deleted_stream(&self) -> Option<Stream<'a>> {
            ...
            unsafe {
                self._tab.get::<flatbuffers::ForwardsUOffset<Stream>>(
                    DeleteStreamResult::VT_DELETED_STREAM,
                    None,
                )
            }
        }
        ...
        pub fn error_code(&self) -> ErrorCode {
            ...
            unsafe {
                self._tab
                    .get::<ErrorCode>(DeleteStreamResult::VT_ERROR_CODE, Some(ErrorCode::NONE))
                    .unwrap()
            }
        }
        #[inline]
        pub fn error_message(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(
                    DeleteStreamResult::VT_ERROR_MESSAGE,
                    None,
                )
            }
        }
    ...
    impl<'a: 'b, 'b> DeleteStreamResultBuilder<'a, 'b> {
        ...
        pub fn add_error_code(&mut self, error_code: ErrorCode) {
            self.fbb_.push_slot::<ErrorCode>(
                DeleteStreamResult::VT_ERROR_CODE,
                error_code,
                ErrorCode::NONE,
            );
        }
    ...
    impl<'a> UpdateStreamsRequest<'a> {
        ...
        pub fn timeout_ms(&self) -> i32 {
            ...
            unsafe {
                self._tab
                    .get::<i32>(UpdateStreamsRequest::VT_TIMEOUT_MS, Some(0))
                    .unwrap()
            }
        }
        #[inline]
        pub fn streams(
            ...
            unsafe {
                self._tab.get::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Stream>>,
                >>(UpdateStreamsRequest::VT_STREAMS, None)
            }
        }
    }
    ...
    impl<'a: 'b, 'b> UpdateStreamsRequestBuilder<'a, 'b> {
        ...
        pub fn add_timeout_ms(&mut self, timeout_ms: i32) {
            self.fbb_
                .push_slot::<i32>(UpdateStreamsRequest::VT_TIMEOUT_MS, timeout_ms, 0);
        }
        #[inline]
        pub fn add_streams(
            &mut self,
            ...
            self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
                UpdateStreamsRequest::VT_STREAMS,
                streams,
            );
        }
        #[inline]
        pub fn new(
            _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>,
        ) -> UpdateStreamsRequestBuilder<'a, 'b> {
            let start = _fbb.start_table();
    ...
    impl<'a> UpdateStreamsResponse<'a> {
        ...
        pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
            ...
            if let Some(x) = args.update_responses {
                builder.add_update_responses(x);
            }
            builder.add_throttle_time_ms(args.throttle_time_ms);
            builder.add_error_code(args.error_code);
            builder.finish()
        ...
        pub fn throttle_time_ms(&self) -> i32 {
            ...
            unsafe {
                self._tab
                    .get::<i32>(UpdateStreamsResponse::VT_THROTTLE_TIME_MS, Some(0))
                    .unwrap()
            }
        }
        #[inline]
        pub fn update_responses(
            &self,
        ) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<UpdateStreamResult<'a>>>>
        {
            // Safety:
            // Created from valid Table for this object
            // which contains a valid value in this slot
            unsafe {
                self._tab.get::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<UpdateStreamResult>>,
                >>(UpdateStreamsResponse::VT_UPDATE_RESPONSES, None)
            }
        }
        #[inline]
        pub fn error_code(&self) -> ErrorCode {
            ...
            unsafe {
                self._tab
                    .get::<ErrorCode>(UpdateStreamsResponse::VT_ERROR_CODE, Some(ErrorCode::NONE))
                    .unwrap()
            }
        }
        #[inline]
        pub fn error_message(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(
                    UpdateStreamsResponse::VT_ERROR_MESSAGE,
                    None,
                )
            }
        }
    ...
    impl flatbuffers::Verifiable for UpdateStreamsResponse<'_> {
        ...
        fn run_verifier(
            ...
            v.visit_table(pos)?
                .visit_field::<i32>("throttle_time_ms", Self::VT_THROTTLE_TIME_MS, false)?
                .visit_field::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<UpdateStreamResult>>,
                >>("update_responses", Self::VT_UPDATE_RESPONSES, false)?
                .visit_field::<ErrorCode>("error_code", Self::VT_ERROR_CODE, false)?
                .visit_field::<flatbuffers::ForwardsUOffset<&str>>(
                    "error_message",
                    Self::VT_ERROR_MESSAGE,
    ...
    pub struct UpdateStreamsResponseArgs<'a> {
        pub throttle_time_ms: i32,
        pub update_responses: Option<
            flatbuffers::WIPOffset<
                flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<UpdateStreamResult<'a>>>,
            >,
        >,
        pub error_code: ErrorCode,
        pub error_message: Option<flatbuffers::WIPOffset<&'a str>>,
    ...
    impl<'a: 'b, 'b> UpdateStreamsResponseBuilder<'a, 'b> {
        ...
        pub fn add_throttle_time_ms(&mut self, throttle_time_ms: i32) {
            self.fbb_.push_slot::<i32>(
                UpdateStreamsResponse::VT_THROTTLE_TIME_MS,
                throttle_time_ms,
                0,
            );
        }
        #[inline]
        pub fn add_update_responses(
            &mut self,
            update_responses: flatbuffers::WIPOffset<
                flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<UpdateStreamResult<'b>>>,
            >,
        ) {
            self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
                UpdateStreamsResponse::VT_UPDATE_RESPONSES,
                update_responses,
            );
        }
        #[inline]
        pub fn add_error_code(&mut self, error_code: ErrorCode) {
            self.fbb_.push_slot::<ErrorCode>(
                UpdateStreamsResponse::VT_ERROR_CODE,
                error_code,
                ErrorCode::NONE,
            );
        }
        ...
        pub fn new(
            _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>,
        ) -> UpdateStreamsResponseBuilder<'a, 'b> {
            let start = _fbb.start_table();
    ...
    impl<'a> UpdateStreamResult<'a> {
        ...
        pub fn error_code(&self) -> ErrorCode {
            ...
            unsafe {
                self._tab
                    .get::<ErrorCode>(UpdateStreamResult::VT_ERROR_CODE, Some(ErrorCode::NONE))
                    .unwrap()
            }
        }
        #[inline]
        pub fn error_message(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(
                    UpdateStreamResult::VT_ERROR_MESSAGE,
                    None,
                )
            }
        }
    ...
    impl<'a: 'b, 'b> UpdateStreamResultBuilder<'a, 'b> {
        ...
        pub fn add_error_code(&mut self, error_code: ErrorCode) {
            self.fbb_.push_slot::<ErrorCode>(
                UpdateStreamResult::VT_ERROR_CODE,
                error_code,
                ErrorCode::NONE,
            );
        }
    ...
    impl<'a> DescribeStreamsRequest<'a> {
        ...
        pub fn timeout_ms(&self) -> i32 {
            ...
            unsafe {
                self._tab
                    .get::<i32>(DescribeStreamsRequest::VT_TIMEOUT_MS, Some(0))
                    .unwrap()
            }
        }
        #[inline]
            ...
            unsafe {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, i64>>>(
                        DescribeStreamsRequest::VT_STREAM_IDS,
                        None,
                    )
            }
        }
    ...
    impl<'a: 'b, 'b> DescribeStreamsRequestBuilder<'a, 'b> {
        ...
        pub fn add_timeout_ms(&mut self, timeout_ms: i32) {
            self.fbb_
                .push_slot::<i32>(DescribeStreamsRequest::VT_TIMEOUT_MS, timeout_ms, 0);
        }
        #[inline]
        pub fn add_stream_ids(
            &mut self,
            stream_ids: flatbuffers::WIPOffset<flatbuffers::Vector<'b, i64>>,
        ) {
            self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
                DescribeStreamsRequest::VT_STREAM_IDS,
                stream_ids,
        ...
        pub fn new(
            _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>,
        ) -> DescribeStreamsRequestBuilder<'a, 'b> {
            let start = _fbb.start_table();
    ...
    impl<'a> DescribeStreamsResponse<'a> {
        ...
        pub fn throttle_time_ms(&self) -> i32 {
            ...
            unsafe {
                self._tab
                    .get::<i32>(DescribeStreamsResponse::VT_THROTTLE_TIME_MS, Some(0))
                    .unwrap()
            }
        }
        #[inline]
        pub fn describe_responses(
            &self,
        ) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<DescribeStreamResult<'a>>>>
        {
            // Safety:
            // Created from valid Table for this object
            // which contains a valid value in this slot
            unsafe {
                self._tab.get::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<DescribeStreamResult>>,
                >>(DescribeStreamsResponse::VT_DESCRIBE_RESPONSES, None)
            }
        }
        #[inline]
        pub fn error_code(&self) -> ErrorCode {
            ...
            unsafe {
                self._tab
                    .get::<ErrorCode>(
                        DescribeStreamsResponse::VT_ERROR_CODE,
                        Some(ErrorCode::NONE),
                    )
                    .unwrap()
            }
        ...
        pub fn error_message(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(
                    DescribeStreamsResponse::VT_ERROR_MESSAGE,
                    None,
                )
            }
        }
    ...
    impl flatbuffers::Verifiable for DescribeStreamsResponse<'_> {
        ...
        fn run_verifier(
            ...
            v.visit_table(pos)?
                .visit_field::<i32>("throttle_time_ms", Self::VT_THROTTLE_TIME_MS, false)?
                .visit_field::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<DescribeStreamResult>>,
                >>("describe_responses", Self::VT_DESCRIBE_RESPONSES, false)?
                .visit_field::<ErrorCode>("error_code", Self::VT_ERROR_CODE, false)?
                .visit_field::<flatbuffers::ForwardsUOffset<&str>>(
                    "error_message",
    ...
    pub struct DescribeStreamsResponseArgs<'a> {
        ...
        pub describe_responses: Option<
            flatbuffers::WIPOffset<
                flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<DescribeStreamResult<'a>>>,
            >,
        >,
        pub error_code: ErrorCode,
        pub error_message: Option<flatbuffers::WIPOffset<&'a str>>,
    ...
    impl<'a: 'b, 'b> DescribeStreamsResponseBuilder<'a, 'b> {
        ...
        pub fn add_throttle_time_ms(&mut self, throttle_time_ms: i32) {
            self.fbb_.push_slot::<i32>(
                DescribeStreamsResponse::VT_THROTTLE_TIME_MS,
                throttle_time_ms,
                0,
            );
        }
        ...
        pub fn add_describe_responses(
            &mut self,
            describe_responses: flatbuffers::WIPOffset<
                flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<DescribeStreamResult<'b>>>,
            >,
        ) {
            self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
                DescribeStreamsResponse::VT_DESCRIBE_RESPONSES,
                describe_responses,
            );
        }
        #[inline]
        ...
        pub fn new(
            _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>,
        ) -> DescribeStreamsResponseBuilder<'a, 'b> {
            let start = _fbb.start_table();
    ...
    impl<'a> DescribeStreamResult<'a> {
        ...
        pub fn stream(&self) -> Option<Stream<'a>> {
            ...
            unsafe {
                self._tab.get::<flatbuffers::ForwardsUOffset<Stream>>(
                    DescribeStreamResult::VT_STREAM,
                    None,
                )
            }
        }
        ...
        pub fn error_code(&self) -> ErrorCode {
            ...
            unsafe {
                self._tab
                    .get::<ErrorCode>(DescribeStreamResult::VT_ERROR_CODE, Some(ErrorCode::NONE))
                    .unwrap()
            }
        }
        #[inline]
        pub fn error_message(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(
                    DescribeStreamResult::VT_ERROR_MESSAGE,
                    None,
                )
            }
        }
    ...
    impl<'a: 'b, 'b> DescribeStreamResultBuilder<'a, 'b> {
        ...
        pub fn add_error_code(&mut self, error_code: ErrorCode) {
            self.fbb_.push_slot::<ErrorCode>(
                DescribeStreamResult::VT_ERROR_CODE,
                error_code,
                ErrorCode::NONE,
            );
        }
        ...
        pub fn new(
            _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>,
        ) -> DescribeStreamResultBuilder<'a, 'b> {
            let start = _fbb.start_table();
    ...
    impl<'a> TrimeStreamsRequest<'a> {
        ...
        pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
            ...
            if let Some(x) = args.trimmed_streams {
                builder.add_trimmed_streams(x);
            }
            builder.add_timeout_ms(args.timeout_ms);
            builder.finish()
        }
        ...
        pub fn timeout_ms(&self) -> i32 {
            ...
            unsafe {
                self._tab
                    .get::<i32>(TrimeStreamsRequest::VT_TIMEOUT_MS, Some(0))
                    .unwrap()
            }
        }
        #[inline]
        pub fn trimmed_streams(
            &self,
        ) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<TrimmedStream<'a>>>>
        {
            // Safety:
            // Created from valid Table for this object
            // which contains a valid value in this slot
            unsafe {
                self._tab.get::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<TrimmedStream>>,
                >>(TrimeStreamsRequest::VT_TRIMMED_STREAMS, None)
            }
        }
    }
    ...
    impl flatbuffers::Verifiable for TrimeStreamsRequest<'_> {
        ...
        fn run_verifier(
            ...
            v.visit_table(pos)?
                .visit_field::<i32>("timeout_ms", Self::VT_TIMEOUT_MS, false)?
                .visit_field::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<TrimmedStream>>,
                >>("trimmed_streams", Self::VT_TRIMMED_STREAMS, false)?
                .finish();
            Ok(())
        }
    }
    pub struct TrimeStreamsRequestArgs<'a> {
        pub timeout_ms: i32,
        pub trimmed_streams: Option<
            flatbuffers::WIPOffset<
                flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<TrimmedStream<'a>>>,
            >,
        >,
    }
    ...
    impl<'a: 'b, 'b> TrimeStreamsRequestBuilder<'a, 'b> {
        ...
        pub fn add_timeout_ms(&mut self, timeout_ms: i32) {
            self.fbb_
                .push_slot::<i32>(TrimeStreamsRequest::VT_TIMEOUT_MS, timeout_ms, 0);
        }
        #[inline]
        pub fn add_trimmed_streams(
            &mut self,
            trimmed_streams: flatbuffers::WIPOffset<
                flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<TrimmedStream<'b>>>,
            >,
        ) {
            self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
                TrimeStreamsRequest::VT_TRIMMED_STREAMS,
                trimmed_streams,
            );
        }
        #[inline]
        pub fn new(
            _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>,
        ) -> TrimeStreamsRequestBuilder<'a, 'b> {
            let start = _fbb.start_table();
    ...
    impl<'a> TrimmedStream<'a> {
        ...
        pub fn stream_id(&self) -> i64 {
            ...
            unsafe {
                self._tab
                    .get::<i64>(TrimmedStream::VT_STREAM_ID, Some(0))
                    .unwrap()
            }
        }
        #[inline]
        pub fn trim_offset(&self) -> i64 {
            ...
            unsafe {
                self._tab
                    .get::<i64>(TrimmedStream::VT_TRIM_OFFSET, Some(0))
                    .unwrap()
            }
        }
    }
    ...
    impl<'a: 'b, 'b> TrimmedStreamBuilder<'a, 'b> {
        ...
        pub fn add_stream_id(&mut self, stream_id: i64) {
            self.fbb_
                .push_slot::<i64>(TrimmedStream::VT_STREAM_ID, stream_id, 0);
        }
        #[inline]
        pub fn add_trim_offset(&mut self, trim_offset: i64) {
            self.fbb_
                .push_slot::<i64>(TrimmedStream::VT_TRIM_OFFSET, trim_offset, 0);
        }
        #[inline]
        pub fn new(
            _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>,
        ) -> TrimmedStreamBuilder<'a, 'b> {
            let start = _fbb.start_table();
    ...
    impl<'a> TrimStreamsResponse<'a> {
        ...
        pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
            ...
            if let Some(x) = args.trim_responses {
                builder.add_trim_responses(x);
            }
            builder.add_throttle_time_ms(args.throttle_time_ms);
            builder.add_error_code(args.error_code);
            builder.finish()
        ...
        pub fn trim_responses(
            &self,
        ) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<TrimStreamResult<'a>>>>
        {
            // Safety:
            // Created from valid Table for this object
            // which contains a valid value in this slot
            unsafe {
                self._tab.get::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<TrimStreamResult>>,
                >>(TrimStreamsResponse::VT_TRIM_RESPONSES, None)
            }
        }
        #[inline]
        pub fn error_code(&self) -> ErrorCode {
            ...
            unsafe {
                self._tab
                    .get::<ErrorCode>(TrimStreamsResponse::VT_ERROR_CODE, Some(ErrorCode::NONE))
                    .unwrap()
            }
        }
        #[inline]
        pub fn error_message(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(
                    TrimStreamsResponse::VT_ERROR_MESSAGE,
                    None,
                )
            }
        }
    ...
    impl flatbuffers::Verifiable for TrimStreamsResponse<'_> {
        ...
        fn run_verifier(
            ...
            v.visit_table(pos)?
                .visit_field::<i32>("throttle_time_ms", Self::VT_THROTTLE_TIME_MS, false)?
                .visit_field::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<TrimStreamResult>>,
                >>("trim_responses", Self::VT_TRIM_RESPONSES, false)?
                .visit_field::<ErrorCode>("error_code", Self::VT_ERROR_CODE, false)?
                .visit_field::<flatbuffers::ForwardsUOffset<&str>>(
                    "error_message",
                    Self::VT_ERROR_MESSAGE,
    ...
    pub struct TrimStreamsResponseArgs<'a> {
        pub throttle_time_ms: i32,
        pub trim_responses: Option<
            flatbuffers::WIPOffset<
                flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<TrimStreamResult<'a>>>,
            >,
        >,
        pub error_code: ErrorCode,
        pub error_message: Option<flatbuffers::WIPOffset<&'a str>>,
    ...
    impl<'a: 'b, 'b> TrimStreamsResponseBuilder<'a, 'b> {
        ...
        #[inline]
        pub fn add_trim_responses(
            &mut self,
            trim_responses: flatbuffers::WIPOffset<
                flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<TrimStreamResult<'b>>>,
            >,
        ) {
            self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
                TrimStreamsResponse::VT_TRIM_RESPONSES,
                trim_responses,
            );
        }
        #[inline]
        pub fn add_error_code(&mut self, error_code: ErrorCode) {
            self.fbb_.push_slot::<ErrorCode>(
                TrimStreamsResponse::VT_ERROR_CODE,
                error_code,
                ErrorCode::NONE,
            );
        }
    ...
    impl<'a> TrimStreamResult<'a> {
        ...
        pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
            ...
            if let Some(x) = args.trimmed_stream {
                builder.add_trimmed_stream(x);
            }
            builder.add_error_code(args.error_code);
            builder.finish()
        }
        ...
        pub fn trimmed_stream(&self) -> Option<Stream<'a>> {
            ...
            unsafe {
                self._tab.get::<flatbuffers::ForwardsUOffset<Stream>>(
                    TrimStreamResult::VT_TRIMMED_STREAM,
                    None,
                )
            }
        }
        ...
        pub fn error_code(&self) -> ErrorCode {
            ...
            unsafe {
                self._tab
                    .get::<ErrorCode>(TrimStreamResult::VT_ERROR_CODE, Some(ErrorCode::NONE))
                    .unwrap()
            }
        }
        #[inline]
        pub fn error_message(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(
                    TrimStreamResult::VT_ERROR_MESSAGE,
                    None,
                )
            }
        }
        ...
        pub fn range(&self) -> Option<Range<'a>> {
            ...
            unsafe {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<Range>>(TrimStreamResult::VT_RANGE, None)
            }
        }
    }
    ...
    impl<'a: 'b, 'b> TrimStreamResultBuilder<'a, 'b> {
        ...
        pub fn add_error_code(&mut self, error_code: ErrorCode) {
            self.fbb_.push_slot::<ErrorCode>(
                TrimStreamResult::VT_ERROR_CODE,
                error_code,
                ErrorCode::NONE,
            );
        }
    ...
    impl<'a> ReportMetricsRequest<'a> {
        ...
        pub fn disk_in_rate(&self) -> i64 {
            ...
            unsafe {
                self._tab
                    .get::<i64>(ReportMetricsRequest::VT_DISK_IN_RATE, Some(0))
                    .unwrap()
            }
        }
        #[inline]
        pub fn disk_out_rate(&self) -> i64 {
            ...
            unsafe {
                self._tab
                    .get::<i64>(ReportMetricsRequest::VT_DISK_OUT_RATE, Some(0))
                    .unwrap()
            }
        }
        #[inline]
        pub fn disk_free_space(&self) -> i64 {
            ...
            unsafe {
                self._tab
                    .get::<i64>(ReportMetricsRequest::VT_DISK_FREE_SPACE, Some(0))
                    .unwrap()
            }
        }
        #[inline]
        pub fn disk_unindexed_data_size(&self) -> i64 {
            ...
            unsafe {
                self._tab
                    .get::<i64>(ReportMetricsRequest::VT_DISK_UNINDEXED_DATA_SIZE, Some(0))
                    .unwrap()
            }
        }
        #[inline]
        pub fn memory_used(&self) -> i64 {
            ...
            unsafe {
                self._tab
                    .get::<i64>(ReportMetricsRequest::VT_MEMORY_USED, Some(0))
                    .unwrap()
            }
        }
        #[inline]
        pub fn uring_task_rate(&self) -> i16 {
            ...
            unsafe {
                self._tab
                    .get::<i16>(ReportMetricsRequest::VT_URING_TASK_RATE, Some(0))
                    .unwrap()
            }
        }
        #[inline]
        pub fn uring_inflight_task_cnt(&self) -> i16 {
            ...
            unsafe {
                self._tab
                    .get::<i16>(ReportMetricsRequest::VT_URING_INFLIGHT_TASK_CNT, Some(0))
                    .unwrap()
            }
        }
        #[inline]
        pub fn uring_pending_task_cnt(&self) -> i32 {
            ...
            unsafe {
                self._tab
                    .get::<i32>(ReportMetricsRequest::VT_URING_PENDING_TASK_CNT, Some(0))
                    .unwrap()
            }
        }
        #[inline]
        pub fn uring_task_avg_latency(&self) -> i16 {
            ...
            unsafe {
                self._tab
                    .get::<i16>(ReportMetricsRequest::VT_URING_TASK_AVG_LATENCY, Some(0))
                    .unwrap()
            }
        }
        #[inline]
        pub fn network_append_rate(&self) -> i16 {
            ...
            unsafe {
                self._tab
                    .get::<i16>(ReportMetricsRequest::VT_NETWORK_APPEND_RATE, Some(0))
                    .unwrap()
            }
        }
        #[inline]
        pub fn network_fetch_rate(&self) -> i16 {
            ...
            unsafe {
                self._tab
                    .get::<i16>(ReportMetricsRequest::VT_NETWORK_FETCH_RATE, Some(0))
                    .unwrap()
            }
        }
        #[inline]
        pub fn network_failed_append_rate(&self) -> i16 {
            ...
            unsafe {
                self._tab
                    .get::<i16>(ReportMetricsRequest::VT_NETWORK_FAILED_APPEND_RATE, Some(0))
                    .unwrap()
            }
        }
        #[inline]
        pub fn network_failed_fetch_rate(&self) -> i16 {
            ...
            unsafe {
                self._tab
                    .get::<i16>(ReportMetricsRequest::VT_NETWORK_FAILED_FETCH_RATE, Some(0))
                    .unwrap()
            }
        }
        #[inline]
        pub fn network_append_avg_latency(&self) -> i16 {
            ...
            unsafe {
                self._tab
                    .get::<i16>(ReportMetricsRequest::VT_NETWORK_APPEND_AVG_LATENCY, Some(0))
                    .unwrap()
            }
        }
        #[inline]
        pub fn network_fetch_avg_latency(&self) -> i16 {
            ...
            unsafe {
                self._tab
                    .get::<i16>(ReportMetricsRequest::VT_NETWORK_FETCH_AVG_LATENCY, Some(0))
                    .unwrap()
            }
        }
        #[inline]
        pub fn range_missing_replica_cnt(&self) -> i16 {
            ...
            unsafe {
                self._tab
                    .get::<i16>(ReportMetricsRequest::VT_RANGE_MISSING_REPLICA_CNT, Some(0))
                    .unwrap()
            }
        }
        #[inline]
        pub fn range_active_cnt(&self) -> i16 {
            ...
            unsafe {
                self._tab
                    .get::<i16>(ReportMetricsRequest::VT_RANGE_ACTIVE_CNT, Some(0))
                    .unwrap()
            }
        }
    }
    ...
    impl<'a: 'b, 'b> ReportMetricsRequestBuilder<'a, 'b> {
        ...
        pub fn add_disk_in_rate(&mut self, disk_in_rate: i64) {
            self.fbb_
                .push_slot::<i64>(ReportMetricsRequest::VT_DISK_IN_RATE, disk_in_rate, 0);
        }
        #[inline]
        pub fn add_disk_out_rate(&mut self, disk_out_rate: i64) {
            self.fbb_
                .push_slot::<i64>(ReportMetricsRequest::VT_DISK_OUT_RATE, disk_out_rate, 0);
        }
        #[inline]
        pub fn add_disk_free_space(&mut self, disk_free_space: i64) {
            self.fbb_.push_slot::<i64>(
                ReportMetricsRequest::VT_DISK_FREE_SPACE,
                disk_free_space,
                0,
            );
        }
        ...
        pub fn add_disk_unindexed_data_size(&mut self, disk_unindexed_data_size: i64) {
            self.fbb_.push_slot::<i64>(
                ReportMetricsRequest::VT_DISK_UNINDEXED_DATA_SIZE,
                disk_unindexed_data_size,
                0,
            );
        }
        ...
        pub fn add_memory_used(&mut self, memory_used: i64) {
            self.fbb_
                .push_slot::<i64>(ReportMetricsRequest::VT_MEMORY_USED, memory_used, 0);
        }
        #[inline]
        pub fn add_uring_task_rate(&mut self, uring_task_rate: i16) {
            self.fbb_.push_slot::<i16>(
                ReportMetricsRequest::VT_URING_TASK_RATE,
                uring_task_rate,
                0,
            );
        }
        ...
        pub fn add_uring_inflight_task_cnt(&mut self, uring_inflight_task_cnt: i16) {
            self.fbb_.push_slot::<i16>(
                ReportMetricsRequest::VT_URING_INFLIGHT_TASK_CNT,
                uring_inflight_task_cnt,
                0,
            );
        }
        ...
        pub fn add_uring_pending_task_cnt(&mut self, uring_pending_task_cnt: i32) {
            self.fbb_.push_slot::<i32>(
                ReportMetricsRequest::VT_URING_PENDING_TASK_CNT,
                uring_pending_task_cnt,
                0,
            );
        }
        ...
        pub fn add_uring_task_avg_latency(&mut self, uring_task_avg_latency: i16) {
            self.fbb_.push_slot::<i16>(
                ReportMetricsRequest::VT_URING_TASK_AVG_LATENCY,
                uring_task_avg_latency,
                0,
            );
        }
        ...
        pub fn add_network_append_rate(&mut self, network_append_rate: i16) {
            self.fbb_.push_slot::<i16>(
                ReportMetricsRequest::VT_NETWORK_APPEND_RATE,
                network_append_rate,
                0,
            );
        }
        ...
        pub fn add_network_fetch_rate(&mut self, network_fetch_rate: i16) {
            self.fbb_.push_slot::<i16>(
                ReportMetricsRequest::VT_NETWORK_FETCH_RATE,
                network_fetch_rate,
                0,
            );
        }
        ...
        pub fn add_network_failed_append_rate(&mut self, network_failed_append_rate: i16) {
            self.fbb_.push_slot::<i16>(
                ReportMetricsRequest::VT_NETWORK_FAILED_APPEND_RATE,
                network_failed_append_rate,
                0,
            );
        }
        ...
        pub fn add_network_failed_fetch_rate(&mut self, network_failed_fetch_rate: i16) {
            self.fbb_.push_slot::<i16>(
                ReportMetricsRequest::VT_NETWORK_FAILED_FETCH_RATE,
                network_failed_fetch_rate,
                0,
            );
        }
        ...
        pub fn add_network_append_avg_latency(&mut self, network_append_avg_latency: i16) {
            self.fbb_.push_slot::<i16>(
                ReportMetricsRequest::VT_NETWORK_APPEND_AVG_LATENCY,
                network_append_avg_latency,
                0,
            );
        }
        ...
        pub fn add_network_fetch_avg_latency(&mut self, network_fetch_avg_latency: i16) {
            self.fbb_.push_slot::<i16>(
                ReportMetricsRequest::VT_NETWORK_FETCH_AVG_LATENCY,
                network_fetch_avg_latency,
                0,
            );
        }
        ...
        pub fn add_range_missing_replica_cnt(&mut self, range_missing_replica_cnt: i16) {
            self.fbb_.push_slot::<i16>(
                ReportMetricsRequest::VT_RANGE_MISSING_REPLICA_CNT,
                range_missing_replica_cnt,
                0,
            );
        }
        ...
        pub fn add_range_active_cnt(&mut self, range_active_cnt: i16) {
            self.fbb_.push_slot::<i16>(
                ReportMetricsRequest::VT_RANGE_ACTIVE_CNT,
                range_active_cnt,
                0,
            );
        }
    ...
    impl<'a> ReportMetricsResponse<'a> {
        ...
        pub fn error_code(&self) -> ErrorCode {
            ...
            unsafe {
                self._tab
                    .get::<ErrorCode>(ReportMetricsResponse::VT_ERROR_CODE, Some(ErrorCode::NONE))
                    .unwrap()
            }
        }
        #[inline]
        pub fn error_message(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(
                    ReportMetricsResponse::VT_ERROR_MESSAGE,
                    None,
                )
            }
        }
    ...
    impl<'a: 'b, 'b> ReportMetricsResponseBuilder<'a, 'b> {
        ...
        pub fn add_error_code(&mut self, error_code: ErrorCode) {
            self.fbb_.push_slot::<ErrorCode>(
                ReportMetricsResponse::VT_ERROR_CODE,
                error_code,
                ErrorCode::NONE,
            );
        }

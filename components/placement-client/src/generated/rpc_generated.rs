...
pub mod elastic {
    ...
    pub mod store {
        ...
        pub fn size_prefixed_root_as_list_range(
            buf: &[u8],
        ) -> Result<ListRange, flatbuffers::InvalidFlatbuffer> {
        ...
        #[inline]
        pub fn finish_size_prefixed_list_range_buffer<'a, 'b>(
            fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>,
            root: flatbuffers::WIPOffset<ListRange<'a>>,
        ) {
